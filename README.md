[![Build Status](http://brain-score-jenkins.com:8080/buildStatus/icon?job=vision_daily_test)](http://brain-score-jenkins.com:8080/buildStatus/icon?job=vision_daily_test)
