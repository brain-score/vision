...
class BenchmarkPool(dict):
    def __init__(self):
        ...
        from .freemanziemba2013 import MovshonFreemanZiemba2013V1PLS, MovshonFreemanZiemba2013V2PLS, \
            ...
            MovshonFreemanZiemba2013V1PLSPrivate, MovshonFreemanZiemba2013V1PLSPublic
        ...
        self['movshon.FreemanZiemba2013.private.V1-pls'] = LazyLoad(MovshonFreemanZiemba2013V1PLSPrivate)
