...
def test_starts_valid_recording_target(identifier: str):
    ...
    assert probe_model.recording_target in attrs(BrainModel.RecordingTarget)  # todo: direct attrs of RecordingTarget
...
class ProbeModel(BrainModel):
    ...
    def __init__(self, stop_on: Union[ProbeModel.STOP, List[ProbeModel.STOP]], visual_degrees: int = 8):
