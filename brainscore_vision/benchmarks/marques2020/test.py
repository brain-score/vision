...
@pytest.mark.slow
@pytest.mark.parametrize('benchmark, expected', [
    ('dicarlo.Marques2020_Cavanaugh2002-grating_summation_field', approx(.776, abs=.01)),
    ('dicarlo.Marques2020_Cavanaugh2002-surround_diameter', approx(.697, abs=.01)),
    ('dicarlo.Marques2020_Cavanaugh2002-surround_suppression_index', approx(.392, abs=.01)),
    ('dicarlo.Marques2020_DeValois1982-pref_or', approx(.769, abs=.01)),
    ('dicarlo.Marques2020_DeValois1982-peak_sf', approx(.708, abs=.01)),
    ('dicarlo.Marques2020_FreemanZiemba2013-texture_modulation_index', approx(.914, abs=.01)),
    ('dicarlo.Marques2020_FreemanZiemba2013-abs_texture_modulation_index', approx(.91, abs=.01)),
    ('dicarlo.Marques2020_FreemanZiemba2013-texture_selectivity', approx(.464, abs=.01)),
    ('dicarlo.Marques2020_FreemanZiemba2013-texture_sparseness', approx(.778, abs=.01)),
    ('dicarlo.Marques2020_FreemanZiemba2013-texture_variance_ratio', approx(.228, abs=.01)),
    ('dicarlo.Marques2020_FreemanZiemba2013-max_texture', approx(.607, abs=.01)),
    ('dicarlo.Marques2020_FreemanZiemba2013-max_noise', approx(.662, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-circular_variance', approx(.777, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-or_bandwidth', approx(.254, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-orth_pref_ratio', approx(.931, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-or_selective', approx(.98, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-cv_bandwidth_ratio', approx(.294, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-opr_cv_diff', approx(.694, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-modulation_ratio', approx(.805, abs=.01)),
    ('dicarlo.Marques2020_Ringach2002-max_dc', approx(.904, abs=.01)),
    ('dicarlo.Marques2020_Schiller1976-sf_selective', approx(.899, abs=.01)),
    ('dicarlo.Marques2020_Schiller1976-sf_bandwidth', approx(.124, abs=.01)),
])
