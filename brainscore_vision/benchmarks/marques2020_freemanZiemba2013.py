...
from brainscore_vision.benchmarks._properties_common import PropertiesBenchmark, _assert_texture_activations
from brainscore_vision.benchmarks._properties_common import calc_texture_modulation, calc_sparseness, calc_variance_ratio
