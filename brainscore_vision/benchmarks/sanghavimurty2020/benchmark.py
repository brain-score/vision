...
class _DicarloSanghaviMurty2020Region(NeuralBenchmark):
    def __init__(self, region: str):
        ...
        self._visual_degrees = 5
        self._number_of_trials = 50
        super(_DicarloSanghaviMurty2020Region, self).__init__(
            identifier=f'dicarlo.SanghaviMurty2020.{region}-{self._identifier_metric_suffix}', version=1,
    ...
    def _load_assembly(self, region, average_repetitions):
        # load data set must be created within brainscore_vision
        assembly = brainscore_vision.load_dataset('dicarlo.SanghaviMurty2020')
