...
subject_1 = pd.read_csv('data_assemblies/contrast_subject-01_session_1.csv')
subject_2 = pd.read_csv('data_assemblies/contrast_subject-02_session_1.csv')
subject_3 = pd.read_csv('data_assemblies/contrast_subject-03_session_1.csv')
subject_4 = pd.read_csv('data_assemblies/contrast_subject-04_session_1.csv')
...
package_data_assembly('brainio_brainscore', assembly, assembly_identifier=assembly.name,
                      stimulus_set_identifier="Geirhos2021_contrast",
