...
https://arxiv.org/pdf/1706.06969.pdf
 ...
 - 16 image categories
 - for the this benchmark (eidolonIII) subjects saw the EXACT image indicated with the variable/column name
...
subject_1 = pd.read_csv('data_assemblies/eidolonIII_subject-01_session_1.csv')
subject_2 = pd.read_csv('data_assemblies/eidolonIII_subject-02_session_1.csv')
subject_3 = pd.read_csv('data_assemblies/eidolonIII_subject-03_session_1.csv')
subject_4 = pd.read_csv('data_assemblies/eidolonIII_subject-04_session_1.csv')
...
assembly.name = 'brendel.Geirhos2021_eidolonIII'
...
package_data_assembly('brainio_brainscore', assembly, assembly_identifier=assembly.name,
                      stimulus_set_identifier="Geirhos2021_eidolonIII",
