...
subject_1 = pd.read_csv('data_assemblies/low-pass_subject-01_session_1.csv')
subject_2 = pd.read_csv('data_assemblies/low-pass_subject-02_session_1.csv')
subject_3 = pd.read_csv('data_assemblies/low-pass_subject-03_session_1.csv')
subject_4 = pd.read_csv('data_assemblies/low-pass_subject-04_session_1.csv')
...
assembly.name = 'brendel.Geirhos2021_low-pass'
...
package_data_assembly('brainio_brainscore', assembly, assembly_identifier=assembly.name,
                      stimulus_set_identifier="Geirhos2021_low-pass",
