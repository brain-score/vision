...
https://arxiv.org/pdf/1706.06969.pdf
 ...
 - for the this benchmark (power-equalisation) subjects saw the EXACT image indicated with the variable/column name
   image_lookup_id, and not a variation of it (no distortions, editing, etc). Condition is either 0 (p.e. not applied), 
   or "pow" (p.e. applied).
'''

# initial csv to dataframe processing:
subject_1 = pd.read_csv('data_assemblies/power-equalisation_subject-01_session_1.csv')
subject_2 = pd.read_csv('data_assemblies/power-equalisation_subject-02_session_1.csv')
subject_3 = pd.read_csv('data_assemblies/power-equalisation_subject-03_session_1.csv')
subject_4 = pd.read_csv('data_assemblies/power-equalisation_subject-04_session_1.csv')
...
assembly.name = 'brendel.Geirhos2021_power-equalisation'
...
# make sure there are only 2 possible conditions, 0 or pow
...
package_data_assembly('brainio_brainscore', assembly, assembly_identifier=assembly.name,
                      stimulus_set_identifier="Geirhos2021_power-equalisation",
