...
** NOTE: This benchmark (silhouette) has a very different stimulus sets then others,
         but is the exact same as the edge benchmark !! 
**
...
https://arxiv.org/pdf/1706.06969.pdf
 ...
 - 16 image categories
 - for the this benchmark (silhouette) subjects saw the EXACT image indicated with the variable/column name
...
subject_1 = pd.read_csv('data_assemblies/silhouette_subject-01_session_1.csv')
subject_2 = pd.read_csv('data_assemblies/silhouette_subject-02_session_1.csv')
subject_3 = pd.read_csv('data_assemblies/silhouette_subject-03_session_1.csv')
subject_4 = pd.read_csv('data_assemblies/silhouette_subject-04_session_1.csv')
subject_5 = pd.read_csv('data_assemblies/silhouette_subject-05_session_1.csv')
subject_6 = pd.read_csv('data_assemblies/silhouette_subject-06_session_1.csv')
subject_7 = pd.read_csv('data_assemblies/silhouette_subject-07_session_1.csv')
subject_8 = pd.read_csv('data_assemblies/silhouette_subject-08_session_1.csv')
subject_9 = pd.read_csv('data_assemblies/silhouette_subject-09_session_1.csv')
subject_10 = pd.read_csv('data_assemblies/silhouette_subject-10_session_1.csv')
...
assembly.name = 'brendel.Geirhos2021_silhouette'
...
package_data_assembly('brainio_brainscore', assembly, assembly_identifier=assembly.name,
                      stimulus_set_identifier="Geirhos2021_silhouette",
                      assembly_class="BehavioralAssembly", bucket_name="brainscore_storage/brainio-brainscore")
