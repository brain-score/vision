...
data_registry['dietterich.Hendrycks2019.noise'] = lambda: load_stimulus_set_from_s3(
...
data_registry['dietterich.Hendrycks2019.blur'] = lambda: load_stimulus_set_from_s3(
...
data_registry['dietterich.Hendrycks2019.weather'] = lambda: load_stimulus_set_from_s3(
...
data_registry['dietterich.Hendrycks2019.digital'] = lambda: load_stimulus_set_from_s3(
