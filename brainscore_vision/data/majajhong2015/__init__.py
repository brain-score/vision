...
data_registry['dicarlo.hvm'] = lambda: load_stimulus_set_from_s3(
...
data_registry['dicarlo.hvm-public'] = lambda: load_stimulus_set_from_s3(
...
data_registry['dicarlo.hvm-private'] = lambda: load_stimulus_set_from_s3(
