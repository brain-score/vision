...
# 2) Make sure you have the things_imgs.mat metadata file for at least one subject, we provide one in this directory.
...
# SHA1 INFORMATION (go to papale2025/__init__.py to make sure they have not changed)
