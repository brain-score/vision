...
def package_data(neural_data_dir: Path, things_image_dir: Path, bucket_name: str, output_path: Path):
    ...
    train_assembly = get_neuroid_assembly(neural_data_dir, train_stimulus_set, 'train')
    test_assembly = get_neuroid_assembly(neural_data_dir, test_stimulus_set, 'test')
