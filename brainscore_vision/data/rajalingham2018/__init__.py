...
# TODO: discuss public vs. private
data_registry['dicarlo.Rajalingham2018.public'] = lambda: load_from_s3(
    identifier="dicarlo.Rajalingham2018.public",
    version_id="",
    sha1="34c6a8b6f7c523589c1861e4123232e5f7c7df4c")

data_registry['dicarlo.Rajalingham2018.private'] = lambda: load_from_s3(
