...
data_registry['dicarlo.Rust2012.single'] = lambda: load_assembly_from_s3(
    ...
    version_id=version_id_df.at[build_filename('dicarlo.Rust2012.single', '.nc'), 'version_id'],
...
data_registry['dicarlo.Rust2012.array'] = lambda: load_assembly_from_s3(
    ...
    version_id=version_id_df.at[build_filename('dicarlo.Rust2012.array', '.nc'), 'version_id'],
...
stimulus_set_registry['dicarlo.Rust2012'] = lambda: load_stimulus_set_from_s3(
    ...
    csv_version_id=version_id_df.at[build_filename('dicarlo.Rust2012', '.csv'), 'version_id'],
    zip_version_id=version_id_df.at[build_filename('dicarlo.Rust2012', '.zip'), 'version_id'])
