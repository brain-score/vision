...
data_registry['dicarlo.Sanghavi2020'] = lambda: load_assembly_from_s3(
    ...
    version_id=version_id_df.at[build_filename('dicarlo.Sanghavi2020', '.nc'), 'version_id'],
...
data_registry['dicarlo.SanghaviJozwik2020'] = lambda: load_assembly_from_s3(
    ...
    version_id=version_id_df.at[build_filename('dicarlo.SanghaviJozwik2020', '.nc'), 'version_id'],
...
data_registry['dicarlo.SanghaviMurty2020'] = lambda: load_assembly_from_s3(
    ...
    version_id=version_id_df.at[build_filename('dicarlo.SanghaviMurty2020', '.nc'), 'version_id'],
...
data_registry['dicarlo.SanghaviMurty2020THINGS1'] = lambda: load_assembly_from_s3(
    ...
    version_id=version_id_df.at[build_filename('dicarlo.SanghaviMurty2020THINGS1', '.nc'), 'version_id'],
...
data_registry['dicarlo.SanghaviMurty2020THINGS2'] = lambda: load_assembly_from_s3(
    ...
    version_id=version_id_df.at[build_filename('dicarlo.SanghaviMurty2020THINGS2', '.nc'), 'version_id'],
...
stimulus_set_registry['dicarlo.BOLD5000'] = lambda: load_stimulus_set_from_s3(
    ...
    csv_version_id=version_id_df.at[build_filename('dicarlo.BOLD5000', '.csv'), 'version_id'],
    zip_version_id=version_id_df.at[build_filename('dicarlo.BOLD5000', '.zip'), 'version_id'])
...
stimulus_set_registry['dicarlo.THINGS1'] = lambda: load_stimulus_set_from_s3(
    ...
    csv_version_id=version_id_df.at[build_filename('dicarlo.THINGS1', '.csv'), 'version_id'],
    zip_version_id=version_id_df.at[build_filename('dicarlo.THINGS1', '.zip'), 'version_id'])
...
stimulus_set_registry['dicarlo.THINGS2'] = lambda: load_stimulus_set_from_s3(
    ...
    csv_version_id=version_id_df.at[build_filename('dicarlo.THINGS2', '.csv'), 'version_id'],
    zip_version_id=version_id_df.at[build_filename('dicarlo.THINGS2', '.zip'), 'version_id'])
