...
# assembly: Savageal2023-fMRI-Defeat
data_registry['Savageal2023-fMRI-Defeat'] = lambda: load_assembly_from_s3(
    identifier="Savageal2023-fMRI-Defeat",
    ...
    stimulus_set_loader=lambda: brainscore_vision.load_stimulus_set('Savageal2023-Defeat'),
)

# stimulus set: Savageal2023-Defeat
stimulus_set_registry['Savageal2023-Defeat'] = lambda: load_stimulus_set_from_s3(
    identifier="Savageal2023-Defeat",
    bucket="brainscore-storage/brainscore-vision/benchmarks/Savageal2023-fMRI-Defeat",
...
# assembly: Savageal2023-fMRI-Growth
data_registry['Savageal2023-fMRI-Growth'] = lambda: load_assembly_from_s3(
    identifier="Savageal2023-fMRI-Growth",
    ...
    cls=NeuronRecordingAssembly,
    stimulus_set_loader=lambda: brainscore_vision.load_stimulus_set('Savageal2023-Growth'),
)

# stimulus set: Savageal2023-Growth
stimulus_set_registry['Savageal2023-Growth'] = lambda: load_stimulus_set_from_s3(
    identifier="Savageal2023-Growth",
    bucket="brainscore-storage/brainscore-vision/benchmarks/Savageal2023-fMRI-Growth",
...
# assembly: Savageal2023-fMRI-Iteration
data_registry['Savageal2023-fMRI-Iteration'] = lambda: load_assembly_from_s3(
    identifier="Savageal2023-fMRI-Iteration",
    ...
    cls=NeuronRecordingAssembly,
    stimulus_set_loader=lambda: brainscore_vision.load_stimulus_set('Savageal2023-Iteration'),
)

# stimulus set: Savageal2023-Iteration
stimulus_set_registry['Savageal2023-Iteration'] = lambda: load_stimulus_set_from_s3(
    identifier="Savageal2023-Iteration",
    bucket="brainscore-storage/brainscore-vision/benchmarks/Savageal2023-fMRI-Iteration",
...
# assembly: Savageal2023-fMRI-Lemonade
data_registry['Savageal2023-fMRI-Lemonade'] = lambda: load_assembly_from_s3(
    identifier="Savageal2023-fMRI-Lemonade",
    ...
    cls=NeuronRecordingAssembly,
    stimulus_set_loader=lambda: brainscore_vision.load_stimulus_set('Savageal2023-Lemonade'),
)

# stimulus set: Savageal2023-Lemonade
stimulus_set_registry['Savageal2023-Lemonade'] = lambda: load_stimulus_set_from_s3(
    identifier="Savageal2023-Lemonade",
    bucket="brainscore-storage/brainscore-vision/benchmarks/Savageal2023-fMRI-Lemonade",
