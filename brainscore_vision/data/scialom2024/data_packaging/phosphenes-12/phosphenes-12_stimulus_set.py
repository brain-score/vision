...
Others:
    ...
    - dataset (RGB, contours, phosphenes or segment stimuli)
...
def collect_scialom_stimulus_set(dataset, percentage_elements, stimuli_directory, metadata_filepath):
    ...
    stimuli.name = f'Scialom2024_{dataset}-{percentage_elements}'  # give the StimulusSet an identifier name
