...
model_registry['20260408_2033_stl10_combined_alpha04'] = lambda: ModelCommitment(
    identifier='20260408_2033_stl10_combined_alpha04',
    activations_model=get_model('20260408_2033_stl10_combined_alpha04'),
    layers=get_layers('20260408_2033_stl10_combined_alpha04'),
    visual_degrees=8,
)
