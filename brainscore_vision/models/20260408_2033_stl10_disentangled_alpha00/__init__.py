...
model_registry['20260408_2033_stl10_disentangled_alpha00'] = lambda: ModelCommitment(
    identifier='20260408_2033_stl10_disentangled_alpha00',
    activations_model=get_model('20260408_2033_stl10_disentangled_alpha00'),
    layers=get_layers('20260408_2033_stl10_disentangled_alpha00'),
    visual_degrees=8,
)
