...
MODEL_IDENTIFIER = '20260408_2033_stl10_disentangled_alpha00'
IMAGE_SIZE = 96
...
def get_model(name):
    ...
    weights_path = load_weight_file(
        ...
        relative_path="20260408_2033_stl10_disentangled_alpha00/weights.pth",
        version_id="null",
        sha1="ab26a6087022fae981ed46168d2035dfead81962",
    )
