...
MODEL_IDENTIFIER = '20260408_2033_stl10_disentangled_alpha04'
IMAGE_SIZE = 96
...
def get_model(name):
    ...
    weights_path = load_weight_file(
        ...
        relative_path="20260408_2033_stl10_disentangled_alpha04/weights.pth",
        version_id="null",
        sha1="5c8d66c99421bce81edee06dd00e3c93f4fb5b8d",
    )
