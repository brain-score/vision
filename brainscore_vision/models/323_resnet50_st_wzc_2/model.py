...
def get_model_list():
    return ['323_resnet50_st_wzc_2']

def get_model(name):
    assert name == '323_resnet50_st_wzc_2'
    ...
    wrapper = PytorchWrapper(identifier='323_resnet50_st_wzc_2', model=model, preprocessing=preprocessing)
