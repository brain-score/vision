...
def get_model_list():
    return ['sketch_model-4s-ep1-test2']


def get_model(name):
    assert name == 'sketch_model-4s-ep1-test2'
...
def get_layers(name):
    assert name == 'sketch_model-4s-ep1-test2'
    return ['activation_1', 'recurrent_cnn_block', 'max_pooling2d_1', 'recurrent_cnn_block_1', 'max_pooling2d_2', 'recurrent_cnn_block_2']
