...
def get_model_list():
    return ['sketch_model-4s-ep1-test4']


def get_model(name):
    assert name == 'sketch_model-4s-ep1-test4'
...
def get_layers(name):
    assert name == 'sketch_model-4s-ep1-test4'
    return ['activation_1', 'recurrent_cnn_block', 'recurrent_cnn_block_1', 'recurrent_cnn_block_2']
