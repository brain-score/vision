...
def get_model_list():
    return ['sketch_model_5g-ep15-try2']


def get_model(name):
    assert name == 'sketch_model_5g-ep15-try2'

    model = RecurrentCNN(fb_loops=8)
    model.load_weights(os.path.join(os.path.dirname(__file__), 'rcnn_cand_5g_weights_15ep/'))
