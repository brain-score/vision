...
def get_model(name):
    ...
    # download_weights(
    #     bucket='brainscore-vision', folder_path='models/braintree-models/weights',
    #     filename_version_sha=[
    #         (f'weights/epoch_100.pth.tar', 'dMNYhC.9bg39SrPZ2bqmUC_5rdd3P5ax', '4d8c9639fca21234cd189db9db81b3f41f3afcf3')],
    # save_directory=os.path.join(os.path.dirname(__file__), 'weights'))
    # weights = torch.load(
    #     os.path.join(os.path.dirname(__file__), f'weights/epoch_100.pth.tar'), 
