...
def get_model(name):
    ...
    weights_path = load_weight_file(bucket="brainscore-vision", folder_name="models",
                                    relative_path="braintree-models/weights/epoch_1001.pth.tar",
                                    version_id="IsBmYeqqs9LRQzRS5NIK8.776Lqad.IY",
                                    sha1="ccc1085a7df71f18ad6a1a0442bd5a7af4634256")
