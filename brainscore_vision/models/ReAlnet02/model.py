...
weights_path = load_weight_file(bucket="brainscore-storage", folder_name="brainscore-vision/models",
                                    relative_path="ReAlnet/ReAlnet02_best_model_params.pt",
                                    version_id="TfGdm1CphJJ1vvkJGcm3n266PHvTuOaV",
                                    sha1="e85769fadb3c09ff88a7d73b01451b6bcccefd77")
...
def get_model():
    ...
    wrapper = PytorchWrapper(identifier='ReAlnet02', model=model, preprocessing=preprocessing)
