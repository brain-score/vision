...
def model_load_weights(identifier: str):
    ...
    version_id = weights_info['version_ids'][identifier_short]
    sha1 = weights_info['sha1s'][identifier_short]

    weights_path = load_weight_file(bucket="brainscore-storage", folder_name="brainscore-vision/models",
                                        relative_path=f"ReAlnet/{identifier_short}_best_model_params.pt",
