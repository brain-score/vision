...
CROP_SIZE  = 224
BATCH_SIZE = 64
S3_PATH = 'https://brainscore-zoo.s3.amazonaws.com/ViT-Base-Patch-16-FAT-ROTINV/checkpoint_epoch5.pt'
MODEL_IDENTIFIER = f'ViT-Base-Patch-16-224-FAT-ROTINV-INPUT-SIZE-{INPUT_SIZE}-CROP-SIZE-{CROP_SIZE}-V1-V2-V4-IT'
LAYERS = ['blocks.1.mlp.act','blocks.6.norm2','blocks.2.mlp.act','blocks.8.norm1']
