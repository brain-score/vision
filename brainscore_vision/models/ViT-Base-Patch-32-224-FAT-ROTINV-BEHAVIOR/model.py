...
CROP_SIZE  = 224
BATCH_SIZE = 64
S3_PATH = 'https://brainscore-zoo.s3.amazonaws.com/ViT-Base-Patch-32-224/checkpoint_epoch5.pt'
MODEL_IDENTIFIER = f'ViT-Base-Patch-32-224-FAT-ROTINV-INPUT-SIZE-{INPUT_SIZE}-CROP-SIZE-{CROP_SIZE}-NOT-BEHAVIOR'
LAYERS = ['pre_logits']
...
# Behavior : pre_logits
# IT       : ['blocks.2.mlp.act','blocks.3.norm2']
# V1       : ['blocks.1.mlp.drop1','blocks.2.norm1']
# V2       : ['blocks.6.norm2','blocks.8.norm1']
# V4       : ['blocks.2.mlp.act','blocks.3.norm2',]
...
# Generate Model
model = create_model('vit_base_patch32_224',pretrained = False)
