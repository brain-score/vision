...
MODEL_IDENTIFIER = f'ViT-Base-Patch-32-224-FAT-ROTINV-INPUT-SIZE-{INPUT_SIZE}-CROP-SIZE-{CROP_SIZE}-V1-V2-V4-IT'
LAYERS = ['blocks.2.norm1','blocks.1.mlp.act','blocks.6.norm2','blocks.2.mlp.act']
