...
CROP_SIZE  = 224
BATCH_SIZE = 64
S3_PATH = 'https://brainscore-zoo.s3.amazonaws.com/ViT-Small-Patch-16-224-FAT-ROTINV/checkpoint_epoch5.pt'
MODEL_IDENTIFIER = f'ViT-Small-Patch-16-224-FAT-ROTINV-INPUT-SIZE-{INPUT_SIZE}-CROP-SIZE-{CROP_SIZE}-V1-V2-V4-IT'
LAYERS = ['blocks.1.mlp.act','blocks.3.attn.proj','blocks.3.norm2','blocks.2.mlp.act','blocks.10.norm1','blocks.9.norm1','blocks.10.norm2','blocks.9.norm2']

PATH_SUB = os.path.dirname(__file__)
wget.download(S3_PATH, PATH_SUB)
WEIGHT_PATH = os.path.join(PATH_SUB,'./checkpoint_epoch5.pt')
print(os.path.join(os.path.dirname(__file__)))
# Description of Layers:
# Behavior : pre_logits
# IT       : ['blocks.10.norm1','blocks.9.norm1','blocks.10.norm2','blocks.9.norm2']
# V1       : ['blocks.1.mlp.act']
# V2       : ['blocks.3.attn.proj']
# V4       : ['blocks.3.norm2','blocks.2.mlp.act']
