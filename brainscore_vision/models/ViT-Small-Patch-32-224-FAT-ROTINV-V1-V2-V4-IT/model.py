...
CROP_SIZE  = 224
BATCH_SIZE = 64
S3_PATH = 'https://brainscore-zoo.s3.amazonaws.com/ViT-Small-Patch-32-224-FAT-ROTINV/checkpoint_epoch5.pt'
MODEL_IDENTIFIER = f'ViT-Small-Patch-32-224-FAT-ROTINV-INPUT-SIZE-{INPUT_SIZE}-CROP-SIZE-{CROP_SIZE}-V1-V2-V4-IT'
LAYERS = ['blocks.7.norm2','blocks.1.mlp.act','blocks.10.norm1','blocks.2.mlp.act']
...
# Generate Model
model = create_model('vit_small_patch32_224',pretrained = False)
