...
def get_model_list():
    return ['Zejin_Lu_dvd_s_imagenet_resnet50']

def get_model(name):
    assert name == 'Zejin_Lu_dvd_s_imagenet_resnet50'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_784/",
                      relative_path="dvd_s_checkpoint_best.pth",
                      version_id="Zu9E_3Q3g47i7TtiiHY1nAQBxM0SECWC",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='Zejin_Lu_dvd_s_imagenet_resnet50', model=model, preprocessing=preprocessing)
