...
def get_model(name):
    assert name == 'abl_light_evresnet_50_457_0'
    model = EVNet(
        with_retinablock=True, with_voneblock=True, model_arch='resnet50',
        image_size=224, visual_degrees=7, num_classes=1000, k_exc= 0.9717, with_light_adapt=False,
    ...
    wrapper = PytorchWrapper(
        identifier='abl_light_evresnet_50_457_0',
