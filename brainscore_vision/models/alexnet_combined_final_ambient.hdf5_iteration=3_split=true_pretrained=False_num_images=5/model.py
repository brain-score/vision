...
def get_model_list():
  return ['alexnet_combined_final_ambient.hdf5_iteration\=3_split\=true_pretrained\=False_num_images\=5']
          
def get_model(name):
    assert name == 'alexnet_combined_final_ambient.hdf5_iteration\=3_split\=true_pretrained\=False_num_images\=5'
    ...
    image_size = 224
    url = "https://drive.google.com/file/d/1PWnI0e836l3WufURakjNVGS7RrUfZiAw/view?usp=share_link"
    output = 'epoch=238-val_loss=4.035-validation_accuracy=0.255.ckpt'
