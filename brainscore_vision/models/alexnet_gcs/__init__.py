...
# model_registry['new_alexnet_gcs_FOV-5'] = lambda: ModelCommitment(
#     identifier='new_alexnet_gcs_FOV-5',
#     activations_model=get_gcs_model(fov=5),
#     layers=GCS_LAYERS)
model_registry['new_alexnet_gcs_FOV-10'] = lambda: ModelCommitment(
    identifier='new_alexnet_gcs_FOV-10',
    activations_model=get_gcs_model(fov=10),
    layers=GCS_LAYERS)
# model_registry['new_alexnet_gcs_FOV-20'] = lambda: ModelCommitment(
#     identifier='new_alexnet_gcs_FOV-20',
