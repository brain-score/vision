...
def get_model_list():
    return ['alexnet_training_seed_01_fov4', 'alexnet_training_seed_01_fov12', 'alexnet_training_seed_01_fov16']

def get_model(name):
    assert name in ['alexnet_training_seed_01_fov4', 'alexnet_training_seed_01_fov12', 'alexnet_training_seed_01_fov16']
