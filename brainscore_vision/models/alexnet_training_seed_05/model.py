...
def get_model_list():
    return ['alexnet_training_seed_05']

def get_model(name):
    assert name == 'alexnet_training_seed_05'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_05.pth", version_id = None, sha1 = "dba2cce7fe35ecdb70caa3bfb4e0b823a8379c8a" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_05', model=model, preprocessing=preprocessing)
