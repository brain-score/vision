...
activations_model = PytorchWrapper(identifier='cb-baseline-model', model=simpleModel(), preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='cb-baseline-model', activations_model=activations_model,
