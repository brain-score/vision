...
model_registry["blur25_vit_large_patch14_clip_224:laion2b_ft_in1k"] = lambda: ModelCommitment(
    identifier="blur25_vit_large_patch14_clip_224:laion2b_ft_in1k",
    activations_model=get_model("blur25_vit_large_patch14_clip_224:laion2b_ft_in1k"),
    layers=MODEL_CONFIGS["blur25_vit_large_patch14_clip_224:laion2b_ft_in1k"]["model_commitment"]["layers"],
    behavioral_readout_layer=MODEL_CONFIGS["blur25_vit_large_patch14_clip_224:laion2b_ft_in1k"]["model_commitment"]["behavioral_readout_layer"],
    region_layer_map=MODEL_CONFIGS["blur25_vit_large_patch14_clip_224:laion2b_ft_in1k"]["model_commitment"]["region_layer_map"]
)


model_registry["blur25_vit_large_patch14_clip_336:laion2b_ft_in1k"] = lambda: ModelCommitment(
    identifier="blur25_vit_large_patch14_clip_336:laion2b_ft_in1k",
    activations_model=get_model("blur25_vit_large_patch14_clip_336:laion2b_ft_in1k"),
    layers=MODEL_CONFIGS["blur25_vit_large_patch14_clip_336:laion2b_ft_in1k"]["model_commitment"]["layers"],
    behavioral_readout_layer=MODEL_CONFIGS["blur25_vit_large_patch14_clip_336:laion2b_ft_in1k"]["model_commitment"]["behavioral_readout_layer"],
    region_layer_map=MODEL_CONFIGS["blur25_vit_large_patch14_clip_336:laion2b_ft_in1k"]["model_commitment"]["region_layer_map"]
)