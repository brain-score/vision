...
#from vonenet.GRCNN import grcnn55
...
class GRCNN(nn.Module):
  ...
  def __init__(self, iters, maps, SKconv, expansion, num_classes):
    ...
    #self.layer1 = GRCL(64, 256, True, self.iters[0], SKconv, self.expansion)
...
weights_file_name = "weights_ft_vonegrcnn.pth"
download_file(weights_file_name, weights_file_name)
#download_folder('vonenet', 'vonenet')

#model.load_state_dict(torch.load(dir_path + "/my_model.pth"))
#init random voneRESNET
model = get_model(model_arch='resnet50', pretrained=False, map_location=device)

#substitute grcnn55 to resnet
model.module.model = grcnn55()

#load pretrained voneGRCNN
checkpoint = torch.load(weights_file_name, map_location=device)
...
all_layers = ['module.vone_block', 'module.bottleneck', 'module.model.layer2', 'module.model.layer2.conv_g_r',  'module.model.layer2.iter_1.8', 'module.model.layer2.iter_g_1.1','module.model.layer2', 'module.model.layer2.iter_2.8' ,'module.model.layer2.iter_g_2.1', 'module.model.layer2.iter_3.8', 
              ...
              'module.model.lastact', 'module.model.avgpool',  'module.model.classifier']
#print(all_layers)



# get an activations model from the Pytorch Wrapper
activations_model = PytorchWrapper(identifier='vone_grcnn', model= model,
                                   preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='vone_grcnn', activations_model=activations_model,
