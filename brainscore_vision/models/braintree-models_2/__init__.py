...
model_registry['BT_CORnet-S-4004'] = ModelCommitment(identifier='BT_CORnet-S-4004', activations_model=get_model('BT_CORnet-S-4004'), layers=get_layers('BT_CORnet-S-4004'))
