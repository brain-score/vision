...
def load_model(model_name,
    ...
    checkpoint_url = "https://huggingface.co/cmulliken/chresmax_v3_cl_01_v2/resolve/main/model_best.pth.tar"
...
def get_model(name):
    assert name == 'chresmax_v3_cl_01_v2'
    ...
    wrapper = PytorchWrapper(identifier='chresmax_v3_cl_01_v2', model=model, preprocessing=preprocessing)
