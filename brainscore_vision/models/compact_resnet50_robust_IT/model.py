...
def get_model_list():
    return ['compact_resnet50_robust_IT']


def get_model(name):
    assert name == 'compact_resnet50_robust_IT'

    pytorch_device = torch.device('cpu')


    # ## access local weights
    # load_path = '../convert_shared_compact_models_to_torch/results/models_torch/compact_ResNet50_robust_IT_50filters.pt'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_718/",
                          relative_path="compact_ResNet50_robust_IT_50filters.pt",
                          version_id="la9Z279NodC77i7oW1GXcU4rSO8cavLK")
