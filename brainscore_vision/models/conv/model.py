...
def get_model(name):
    ...
    model_path = './%s.pt' % name  # os.path.join(os.path.dirname(__file__), '/conv.pt')
    file_id = '1RUGiO5lMQUVMc5rKyoQFObFYEB8U75R5'
    ...
    wrapper = PytorchWrapper(identifier='0.5x_resnet-18', model=model, preprocessing=preprocessing)
