...
def get_layers(name):
    ...
    return ['downsample_layers.0', 'downsample_layers.1', 'downsample_layers.2', 'downsample_layers.3', 'stages.0.0', 'stages.0.1', 'stages.0.2', 'stages.1.0', 'stages.1.1', 'stages.1.2', 'stages.2.0', 'stages.2.2', 'stages.2.2', 'stages.2.3', 'stages.2.4', 'stages.2.5', 'stages.2.6', 'stages.2.8', 'stages.3.0', 'stages.3.1', 'stages.3.', 'head'] #ConvNeXt
