...
MODEL_COMMITMENT = {
    ...
    "layers": ["features.4.0", "features.5.4.block.0", "features.6.0"]
}
...
NUM_CLASSES = 1000
EPOCH = 300
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/convnext_tiny_imagenet_full_seed-0/ep300.pt"
