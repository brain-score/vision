...
def get_layers(name):
    ...
    return ['convnextv2.encoder.stages.0.layers.0', 'convnextv2.encoder.stages.0.layers.1', 'convnextv2.encoder.stages.0.layers.2',
            'convnextv2.encoder.stages.1.layers.0', 'convnextv2.encoder.stages.1.layers.1', 'convnextv2.encoder.stages.1.layers.2',
            'convnextv2.encoder.stages.2.layers.0', 'convnextv2.encoder.stages.2.layers.1', 'convnextv2.encoder.stages.2.layers.2',
            'convnextv2.encoder.stages.2.layers.3', 'convnextv2.encoder.stages.2.layers.4', 'convnextv2.encoder.stages.2.layers.5',
            'convnextv2.encoder.stages.2.layers.6', 'convnextv2.encoder.stages.2.layers.7', 'convnextv2.encoder.stages.2.layers.8',
            'convnextv2.encoder.stages.3.layers.0', 'convnextv2.encoder.stages.3.layers.1', 'convnextv2.encoder.stages.3.layers.2',
            ]
