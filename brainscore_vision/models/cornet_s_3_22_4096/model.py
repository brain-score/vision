...
def get_custom_cornet_s():
    ...
    url = f'https://storage.googleapis.com/neurodp/3_22_4096_ckpt.pt'
...
def get_model_list():
        return ['cornet_s_3_22_4096']


def get_model(name):
    assert name == 'cornet_s_3_22_4096'
    model = get_custom_cornet_s()
    preprocessing = functools.partial(load_preprocess_images, image_size=224)
    wrapper = PytorchWrapper(identifier='cornet_s_3_22_4096',
                            model=model,
