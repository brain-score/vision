...
activations_model = PytorchWrapper(identifier='cornet_z_aacn', model=model,
                                   preprocessing=preprocessing)
# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='cornet_z_aacn', activations_model=activations_model,
