...
activations_model = PytorchWrapper(identifier='cornet_z_aacn_2', model=model,
                                   preprocessing=preprocessing)
# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='cornet_z_aacn_2', activations_model=activations_model,
