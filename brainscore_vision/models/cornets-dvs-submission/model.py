...
def download():
    ...
    file_id = "1cXjr-VGwQGQwGThg2Ziqsy-0haIt7mqd"
...
def get_model(name):
    ...
    activations_model = PytorchWrapper(identifier='cornets-dvs', model=model, preprocessing=preprocessing)
...
model = ModelCommitment(identifier='cornets-dvs', activations_model=get_model("cornets-dvs"),
