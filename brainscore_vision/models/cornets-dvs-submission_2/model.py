...
def download():
    ...
    file_id = "1HsLLR4a1k4EYbk78CWo-o80mwy9Sf_i7"
...
def get_model(name):
    ...
    activations_model = PytorchWrapper(identifier='cornets-cifar10', model=model, preprocessing=preprocessing)
...
model = ModelCommitment(identifier='cornets-cifar10', activations_model=get_model("cornets-cifar10"),
