...
def download():
    ...
    file_id = "1zaHNOnbFAPDNyL72Y4dh96v3oCqIXKFJ"
...
def get_model(name):
    ...
    """
    assert name == 'cornets-cifar10dvs'
    download()
    model = CORnet_S(3)
    ...
    activations_model = PytorchWrapper(identifier='cornets-cifar10dvs', model=model, preprocessing=preprocessing)
...
model = ModelCommitment(identifier='cornets-cifar10dvs', activations_model=get_model("cornets-cifar10dvs"),
