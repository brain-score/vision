...
def download():
    ...
    file_id = "1XBLwGDeIgxPpHADG3G5_ILvytjPCrBDj"
...
def get_model(name):
    ...
    """
    assert name == 'vonecornets-cifar10'
    download()
    ...
    activations_model = PytorchWrapper(identifier='vonecornets-cifar10', model=model, preprocessing=preprocessing)
...
model = ModelCommitment(identifier='vonecornets-cifar10', activations_model=get_model("vonecornets-cifar10"),
