...
INPUT_SIZE = 256
BATCH_SIZE = 64
LAYERS = ['patch_embed.1.proj.4','blocks.1.blocks.1.0.norm1','blocks.1.blocks.1.4.norm2','blocks.1.blocks.1.0.mlp.act','blocks.2.revert_projs.1.2']
...
activations_model = PytorchWrapper(identifier='custom_model_cv_18_dagger_408_v2', model=model, preprocessing=preprocessing,batch_size = BATCH_SIZE)
...
def get_model_list():
    return ['custom_model_cv_18_dagger_408_v2']


def get_model(name):
    assert name == 'custom_model_cv_18_dagger_408_v2'    
