...
activations_model = PytorchWrapper(identifier='custom_model_cv_18_dagger_408_v3', model=model, preprocessing=preprocessing)
...
def get_model_list():
    return ['custom_model_cv_18_dagger_408_v3']


def get_model(name):
    assert name == 'custom_model_cv_18_dagger_408_v3'    
