...
activations_model = PytorchWrapper(identifier='custom_model_cv_18_dagger_408_inv_rot', model=model, preprocessing=preprocessing,batch_size = BATCH_SIZE)
...
def get_model_list():
    return ['custom_model_cv_18_dagger_408_inv_rot']


def get_model(name):
    assert name == 'custom_model_cv_18_dagger_408_inv_rot'    
