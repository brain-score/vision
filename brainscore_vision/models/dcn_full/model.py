...
print(model)
activations_model = PytorchWrapper(identifier='dcn_full_adv_cifar10', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='dcn_full_adv_cifar10', activations_model=activations_model,
                        # specify layers to consider
                        layers=['conv1_srf', 'feature_layer1.odefunc.conv2', 'DS1_srf', 'feature_layer2.odefunc.conv2', 'DS2_srf', 'feature_layer3.odefunc.conv2'])
...
def get_model(name):
    ...
    """
    assert name == 'dcn_full_adv_cifar10'
...
def get_layers(name):
    ...
    return ['conv1_srf', 'feature_layer1.odefunc.conv2', 'DS1_srf', 'feature_layer2.odefunc.conv2', 'DS2_srf', 'feature_layer3.odefunc.conv2']
