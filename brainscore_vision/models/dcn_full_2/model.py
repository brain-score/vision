...
print(model)
activations_model = PytorchWrapper(identifier='dcn_full_apr18', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='dcn_full_apr18', activations_model=activations_model,
