...
print(model)
activations_model = PytorchWrapper(identifier='dcn_ode_mar31_tinyImagenet', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='dcn_ode_mar31_tinyImagenet', activations_model=activations_model,
...
def get_model_list():
    ...
    return ['dcn_ode_mar31_tinyImagenet']
...
def get_model(name):
    ...
    """
    assert name == 'dcn_ode_mar31_tinyImagenet'
