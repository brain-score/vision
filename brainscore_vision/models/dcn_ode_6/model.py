...
print(model)
activations_model = PytorchWrapper(identifier='dcn_ode_adv_cifar10', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='dcn_ode_adv_cifar10', activations_model=activations_model,
...
def get_model(name):
    ...
    """
    assert name == 'dcn_ode_adv_cifar10'
