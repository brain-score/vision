...
MODEL_COMMITMENT = {
    ...
    "behavioral_readout_layer": "ffc_norm",
    "layers": ["blocks.18.norm2", "blocks.20.norm2", "blocks.4.norm1", "blocks.9.norm1"]
}
...
NUM_CLASSES = 1000
EPOCH = 300
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/deit_large_imagenet_full_seed-0/ep300.pt"
...
def get_model():
    model = timm.create_model("deit3_large_patch16_224", pretrained=False, num_classes=NUM_CLASSES)
    if NUM_CLASSES != 1000:
