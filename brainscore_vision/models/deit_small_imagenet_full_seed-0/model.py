...
MODEL_COMMITMENT = {
    ...
    "layers": ["blocks.2.norm1", "blocks.5.norm1", "blocks.6.norm2", "blocks.9.norm2"]
}
...
NUM_CLASSES = 1000
EPOCH = 300
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/deit_small_imagenet_full_seed-0/ep300.pt"
