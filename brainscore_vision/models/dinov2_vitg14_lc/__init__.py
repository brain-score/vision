...
# behavioral_readout_layer='linear_head' -> pooled 1000-logit output (clean vector for the
# probabilities/odd-one-out decoders). Label behavior (Geirhos/Baker) uses model(x)->1000 logits directly.
model_registry['dinov2_vitg14_lc'] = lambda: ModelCommitment(
    identifier='dinov2_vitg14_lc',
    activations_model=get_model('dinov2_vitg14_lc'),
    layers=get_layers('dinov2_vitg14_lc'),
