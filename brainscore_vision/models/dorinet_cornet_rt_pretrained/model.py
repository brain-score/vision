...
class dorinet_cornet_rt_pretrained_pretrained(nn.Module):
...
def get_model_list():
    return ["dorinet_cornet_rt_pretrained_pretrained"]
...
__all__ = ["dorinet_CORnet_RT", "dorinet_cornet_rt_pretrained_pretrained"]

model_urls = {
    "dorinet_cornet_rt_pretrained_pretrained": "https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth",
}
