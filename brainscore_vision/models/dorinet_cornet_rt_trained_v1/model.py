...
class dorinet_cornet_rt_trained_v1_trained_v1_V1(nn.Module):
...
def get_model_list():
    return ["dorinet_cornet_rt_trained_v1_trained_v1_V1"]


def get_model():
    model = dorinet_cornet_rt_trained_v1_trained_v1_V1()
    ...
    wrapper = PytorchWrapper(
        identifier="dorinet_cornet_rt_trained_v1_trained_v1_V1", model=model, preprocessing=preprocessing
    )
...
__all__ = ["dorinet_CORnet_RT_V1", "dorinet_cornet_rt_trained_v1_trained_v1_V1"]

model_urls = {
    "dorinet_cornet_rt_trained_v1_trained_v1_V1": "https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth",
}
