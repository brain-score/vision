...
class dorinet_cornet_rt_trained_v2_trained_v2_V2(nn.Module):
...
def get_model_list():
    return ["dorinet_cornet_rt_trained_v2_trained_v2_V2"]


def get_model():
    model = dorinet_cornet_rt_trained_v2_trained_v2_V2()
    ...
    wrapper = PytorchWrapper(
        identifier="dorinet_cornet_rt_trained_v2_trained_v2_V2", model=model, preprocessing=preprocessing
    )
...
__all__ = ["dorinet_CORnet_RT_V2", "dorinet_cornet_rt_trained_v2_trained_v2_V2"]

model_urls = {
    "dorinet_cornet_rt_trained_v2_trained_v2_V2": "https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth",
}
