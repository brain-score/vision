...
class Dorinet_CORnet_RT_V2(nn.Module):
...
def get_model_list():
    return ['Dorinet_CORnet_RT_V2']


def get_model(name):
    assert name == 'Dorinet_CORnet_RT_V2'
    model = Dorinet_CORnet_RT_V2()
    ...
    wrapper = PytorchWrapper(identifier='Dorinet_CORnet_RT_V2', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_CORnet_RT_V2', 'Dorinet_CORnet_RT_V2']

model_urls = {
    'Dorinet_CORnet_RT_V2': 'https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth',
}