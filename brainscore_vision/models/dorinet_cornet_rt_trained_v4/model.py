...
class dorinet_cornet_rt_trained_v4_trained_v4_V4(nn.Module):
...
def get_model_list():
    return ["dorinet_cornet_rt_trained_v4_trained_v4_V4"]


def get_model():
    model = dorinet_cornet_rt_trained_v4_trained_v4_V4()
    ...
    wrapper = PytorchWrapper(
        identifier="dorinet_cornet_rt_trained_v4_trained_v4_V4", model=model, preprocessing=preprocessing
    )
...
__all__ = ["dorinet_CORnet_RT_V4", "dorinet_cornet_rt_trained_v4_trained_v4_V4"]

model_urls = {
    "dorinet_cornet_rt_trained_v4_trained_v4_V4": "https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth",
}
