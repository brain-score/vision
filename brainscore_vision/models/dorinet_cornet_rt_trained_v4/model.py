...
class Dorinet_CORnet_RT_V4(nn.Module):
...
def get_model_list():
    return ['Dorinet_CORnet_RT_V4']


def get_model(name):
    assert name == 'Dorinet_CORnet_RT_V4'
    model = Dorinet_CORnet_RT_V4()
    ...
    wrapper = PytorchWrapper(identifier='Dorinet_CORnet_RT_V4', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_CORnet_RT_V4', 'Dorinet_CORnet_RT_V4']

model_urls = {
    'Dorinet_CORnet_RT_V4': 'https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth',
}