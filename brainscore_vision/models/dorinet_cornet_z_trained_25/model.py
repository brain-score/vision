...
def get_model_list():
    return ['dorinet_cornet_z_25']



def get_model(name):
    assert name == 'dorinet_cornet_z_25'
    model = Dorinet_cornet_z_25()
    ...
    wrapper = PytorchWrapper(identifier='dorinet_cornet_z_25', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_cornet_z_25', 'Dorinet_cornet_z_25']

model_urls = {
    'dorinet_cornet_z_25': 'www.technion.org',
}