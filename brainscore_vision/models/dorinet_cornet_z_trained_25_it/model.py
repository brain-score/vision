...
def get_model_list():
    return ['dorinet_cornet_z_25_IT']



def get_model(name):
    assert name == 'dorinet_cornet_z_25_IT'
    model = Dorinet_cornet_z_25_IT()
    ...
    wrapper = PytorchWrapper(identifier='dorinet_cornet_z_25_IT', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_cornet_z_25_IT', 'Dorinet_cornet_z_25_IT']

model_urls = {
    'dorinet_cornet_z_25_IT': 'www.technion.org',
}