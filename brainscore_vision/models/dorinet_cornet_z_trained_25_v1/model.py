...
def get_model_list():
    return ['dorinet_cornet_z_25_V1']



def get_model(name):
    assert name == 'dorinet_cornet_z_25_V1'
    model = Dorinet_cornet_z_25_V1()
    ...
    wrapper = PytorchWrapper(identifier='dorinet_cornet_z_25_V1', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_cornet_z_25_V1', 'Dorinet_cornet_z_25_V1']

model_urls = {
    'dorinet_cornet_z_25_V1': 'www.technion.org',
}