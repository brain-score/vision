...
def get_model_list():
    return ['dorinet_cornet_z_25_V4']



def get_model(name):
    assert name == 'dorinet_cornet_z_25_V4'
    model = Dorinet_cornet_z_25_V4()
    ...
    wrapper = PytorchWrapper(identifier='dorinet_cornet_z_25_V4', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_cornet_z_25_V4', 'Dorinet_cornet_z_25_V4']

model_urls = {
    'dorinet_cornet_z_25_V4': 'www.technion.org',
}