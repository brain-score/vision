...
def get_model(name):
    ...
    loc_url = '/home/doronr/Downloads/weight_z/latest_checkpoint.pth.tar'

    # file_id = '19REMTntbq6HMBNb3uuftoQ6HQSRXK1vL'
    download_path = './trytrytry.pth'
    gdd.download_file_from_google_drive(file_id='19REMTntbq6HMBNb3uuftoQ6HQSRXK1vL', dest_path=download_path,unzip=False)
