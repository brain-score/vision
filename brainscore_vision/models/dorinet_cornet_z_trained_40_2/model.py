...
def get_model_list():
    return ['dorinet_cornet_z_40']



def get_model(name):
    assert name == 'dorinet_cornet_z_40'
    model = Dorinet_cornet_z_40()
    ...
    wrapper = PytorchWrapper(identifier='dorinet_cornet_z_40', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_cornet_z_40', 'Dorinet_cornet_z_40']

model_urls = {
    'dorinet_cornet_z_40': 'www.technion.org',
}