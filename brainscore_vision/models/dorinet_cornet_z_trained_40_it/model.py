...
def get_model_list():
    return ['dorinet_cornet_z_40_IT']



def get_model(name):
    assert name == 'dorinet_cornet_z_40_IT'
    model = Dorinet_cornet_z_40_IT()
    file_id_loc = '1pbn8EqgGOSf1SS7jG9xx0hZ7t7BLSv5n'
    ...
    wrapper = PytorchWrapper(identifier='dorinet_cornet_z_40_IT', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_cornet_z_40_IT', 'Dorinet_cornet_z_40_IT']

model_urls = {
    'dorinet_cornet_z_40_IT': 'www.technion.org',
}