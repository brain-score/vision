...
def get_model_list():
    return ['dorinet_cornet_z_40_V2']



def get_model(name):
    assert name == 'dorinet_cornet_z_40_V2'
    model = Dorinet_cornet_z_40_V2()
    ...
    wrapper = PytorchWrapper(identifier='dorinet_cornet_z_40_V2', model=model, preprocessing=preprocessing)
...
__all__ = ['dorinet_cornet_z_40_V2', 'Dorinet_cornet_z_40_V2']

model_urls = {
    'dorinet_cornet_z_40_V2': 'www.technion.org',
}