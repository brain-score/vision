...
def get_model_list():
    return ["eBarlow_Vanilla"]


def get_model(name):
    assert name == "eBarlow_Vanilla"
    model = torchvision.models.resnet50(pretrained=False)
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/classifiers/barlow/vanilla/classifier.pt"
    fh = urlretrieve(url)
