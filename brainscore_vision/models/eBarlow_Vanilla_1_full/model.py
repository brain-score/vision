...
def get_model_list():
    return ["eBarlow_Vanilla_1_full"]


def get_model(name):
    assert name == "eBarlow_Vanilla_1_full"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/vanilla/Barlow_1/latest-rank0"
    fh = urlretrieve(url)
