...
def get_model_list():
    return ["eBarlow_Vanilla_2"]


def get_model(name):
    assert name == "eBarlow_Vanilla_2"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/vanilla/Barlow_2/latest-rank0"
    fh = urlretrieve(url)
