...
def get_model_list():
    return ["eBarlow_augself_mlp_1"]


def get_model(name):
    assert name == "eBarlow_augself_mlp_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/augself/mlp/lmda_1.0/Barlow_1/latest-rank0"
    fh = urlretrieve(url)
