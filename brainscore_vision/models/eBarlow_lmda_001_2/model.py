...
def get_model_list():
    return ["eBarlow_lmda_001_2"]


def get_model(name):
    assert name == "eBarlow_lmda_001_2"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/paired/lmda_0.01/Barlow_2/latest-rank0"
    fh = urlretrieve(url)
