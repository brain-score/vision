...
def get_model_list():
    return ["eBarlow_lmda_02_1_full"]


def get_model(name):
    assert name == "eBarlow_lmda_02_1_full"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/paired/lmda_0.2/Barlow_1/latest-rank0"
    fh = urlretrieve(url)
