...
def get_model_list():
    return ["eBarlow_lmda_05_1"]


def get_model(name):
    assert name == "eBarlow_lmda_05_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/paired/lmda_0.5/Barlow_1/latest-rank0"
    fh = urlretrieve(url)
