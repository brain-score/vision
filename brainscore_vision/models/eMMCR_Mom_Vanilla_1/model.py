...
def get_model_list():
    return ["eMMCR_Mom_Vanilla_1"]


def get_model(name):
    assert name == "eMMCR_Mom_Vanilla_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/vanilla/MMCR_Momentum_1/latest-rank0"
    fh = urlretrieve(url)
