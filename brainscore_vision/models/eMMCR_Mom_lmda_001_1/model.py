...
def get_model_list():
    return ["eMMCR_Mom_lmda_001_1"]


def get_model(name):
    assert name == "eMMCR_Mom_lmda_001_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/paired/lmda_0.01/MMCR_Momentum_1/latest-rank0"
    fh = urlretrieve(url)
