...
def get_model_list():
    return ["eMMCR_Mom_lmda_01_2"]


def get_model(name):
    assert name == "eMMCR_Mom_lmda_01_2"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/paired/lmda_0.1/MMCR_Momentum_2/latest-rank0"
    fh = urlretrieve(url)
