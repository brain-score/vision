...
def get_model_list():
    return ["eMMCR_VanillaV2"]


def get_model(name):
    assert name == "eMMCR_VanillaV2"
    model = torchvision.models.resnet50(pretrained=False)
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/classifiers/mmcr/vanilla/classifier.pt"
    fh = urlretrieve(url)
