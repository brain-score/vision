...
def get_model_list():
    return ["eSimCLR_Vanilla_1"]


def get_model(name):
    assert name == "eSimCLR_Vanilla_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/vanilla/SimCLR_1/latest-rank0"
    fh = urlretrieve(url)
