...
def get_model_list():
    return ["eSimCLR_Vanilla_2"]


def get_model(name):
    assert name == "eSimCLR_Vanilla_2"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/vanilla/SimCLR_2/latest-rank0"
    fh = urlretrieve(url)
