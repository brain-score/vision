...
def get_model_list():
    return ["eSimCLR_lmda_02_1_1"]


def get_model(name):
    assert name == "eSimCLR_lmda_02_1_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/fresh/paired/lmda_0.2/SimCLR_1/latest-rank0"
    fh = urlretrieve(url)
