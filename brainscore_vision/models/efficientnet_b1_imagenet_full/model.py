...
MODEL_COMMITMENT = {
    ...
    "layers": ["features.4.0.block.0.1", "features.4.0.block.1.0", "features.6.0.block.3.0"]
}
...
NUM_CLASSES = 1000
EPOCH = 100
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/efficientnet_b1_imagenet_full/ep100.pt"
