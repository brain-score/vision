...
MODEL_COMMITMENT = {
    ...
    "layers": ["features.4.0.block.3.0", "features.5.0.block.1.0", "features.6.0.block.3.0"]
}
...
NUM_CLASSES = 1000
EPOCH = 100
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/efficientnet_b2_imagenet_full/ep100.pt"
