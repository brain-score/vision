...
model_registry['efficientnet-b7'] = ModelCommitment(identifier='efficientnet-b7', activations_model=get_model('efficientnet-b7'), layers=get_layers('efficientnet-b7'))
model_registry['efficientnet-b8'] = ModelCommitment(identifier='efficientnet-b8', activations_model=get_model('efficientnet-b8'), layers=get_layers('efficientnet-b8'))
