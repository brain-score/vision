...
def get_model_list():
    return ['effnetb1_cutmix_augmix_VOne_e7_324x288']
...
def get_model(name):
    assert name == 'effnetb1_cutmix_augmix_VOne_e7_324x288'
    model_tf_efficientnet_b1_ns= EffNetB1VOne()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    model_tf_efficientnet_b1_ns.load_state_dict(torch.load(dir_path + "/tf_efficientnet_b1_ns_VONE_cutmix_augmix_epoch7_score0.35180350583405706_best.pth", map_location=torch.device('cpu'))["model"])
