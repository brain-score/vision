...
def get_model_list():
    return ['effnetb1_cutmixpatch_augmix_robust32_avge4e7_manylayers_324x288']
...
def get_model(name):
    ...
    model_tf_efficientnet_b1_ns.load_state_dict(torch.load(dir_path + "/models/tf_efficientnet_b1_ns_robust_cutmixpatchresize_augmix_e4toe7.pth", map_location=torch.device('cpu'))["model"])
