...
def get_model_list():
    return ['effnetb1_cutmixpatch_augmix_robust30_e2_324x288']
...
def get_model(name):
    assert name == 'effnetb1_cutmixpatch_augmix_robust30_e2_324x288'
    model_tf_efficientnet_b1_ns= EffNetBX()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    model_tf_efficientnet_b1_ns.load_state_dict(torch.load(dir_path + "/tf_efficientnet_b1_ns_robust_liaug_e3_cutmixpatchresize_augmix_epoch2_score0.47176284042003186_best.pth", map_location=torch.device('cpu'))["model"])
