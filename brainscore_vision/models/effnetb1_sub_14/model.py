...
def get_model_list():
    return ['effnetb1_cutmixfix_augmix_e5_392x348']
...
def get_model(name):
    assert name == 'effnetb1_cutmixfix_augmix_e5_392x348'
    model_tf_efficientnet_b1_ns= EffNetBX()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    model_tf_efficientnet_b1_ns.load_state_dict(torch.load(dir_path + "/tf_efficientnet_b1_ns_fixcutmix_augmix_epoch5_score0.5214554180632869_best.pth", map_location=torch.device('cpu'))["model"])
