...
def get_model_list():
    return ['effnetb1_cutmix_augmix_sam_e5_globpool_324x288']
...
def get_model(name):
    assert name == 'effnetb1_cutmix_augmix_sam_e5_globpool_324x288'
    model_tf_efficientnet_b1_ns= EffNetBX()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    model_tf_efficientnet_b1_ns.load_state_dict(torch.load(dir_path + "/tf_efficientnet_b1_ns_cutmix_augmix_SAM_epoch5_score0.5152576101543447_best.pth", map_location=torch.device('cpu'))["model"])
