...
def get_model_list():
    return ['effnetb2_cutmix_augmix_epoch5_348x309']
...
def get_model(name):
    assert name == 'effnetb2_cutmix_augmix_epoch5_348x309'
    dir_path = os.path.dirname(os.path.realpath(__file__))
    model= EffNetBX()
    model.load_state_dict(torch.load(dir_path + "/tf_efficientnet_b2_ns_cutmix_augmix_epoch5_score0.5294720329279423_best.pth", map_location=torch.device('cpu'))["model"])
