...
def get_model():
    ...
    download_weights(
        ...
        folder_path='models/effnetretrain_cutmix_mixup_sub',
        filename_version_sha=[
            ('tf_efficientnet_b0_ns_cutmix_mixup_epoch5_score0.5124597550992295_best.pth',
             'caoFa_Z.qF6Czsq3XC8fT25xn_qLHP_H',
             '5ac9bbbd145e7498bfd035d281d9b30eb7bbc626')],
