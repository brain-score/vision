# eicircuit_resnet18_abs_group_20260921

ResNet-18 with subtractive E/I circuits, absolute nonnegative synaptic weights, grouped inhibitory-to-excitatory connections, learned gain/balance, and residual scaling 1/sqrt(8).

- Training data: ImageNet-1k training split.
- Checkpoint: epoch 89; clean ImageNet validation top-1: 66.430%.
- Parameters: 14,481,280.
...
Upload `eicircuit_resnet18_abs_group_20260921_weights.pt` through your Brain-Score account's Large File Upload page.
