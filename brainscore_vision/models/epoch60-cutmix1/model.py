...
activations_model = PytorchWrapper(identifier='imgnfull-e60-cut1', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='imgnfull-e60-cut1', activations_model=activations_model,
