...
activations_model = PytorchWrapper(identifier='grcnn_robust', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_robust', activations_model=activations_model,
