...
activations_model = PytorchWrapper(identifier='grcnn_corr', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_corr', activations_model=activations_model,
