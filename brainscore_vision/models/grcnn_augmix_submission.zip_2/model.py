...
activations_model = PytorchWrapper(identifier='grcnn_robust_v2', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_robust_v2', activations_model=activations_model,
