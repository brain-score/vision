...
activations_model = PytorchWrapper(identifier='grcnn_corr_v1', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_corr_v1', activations_model=activations_model,
