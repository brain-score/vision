...
weight_file_name = "model_best_cutmix.pth"
...
activations_model = PytorchWrapper(identifier='grcnn_cutmix', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_cutmix', activations_model=activations_model,
