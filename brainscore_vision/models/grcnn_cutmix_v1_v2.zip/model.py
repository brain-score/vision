...
weight_file_name = "model_best_cutmix_v1_v2.pth"
download_file(weight_file_name, weight_file_name)

#model.load_state_dict(torch.load(dir_path + "/my_model.pth"))
model_ft = grcnn55()
model_ft.load_state_dict(torch.load(weight_file_name, map_location = device)["state_dict"])
# all_layers = [ 'layer1', 'layer2', 'layer3', 'layer4', 'lastact',  'classifier']
#all_layers = ['layer1', 'layer1.conv_g_f' , 'layer1.d_conv_1', 'layer1.d_conv_3', 'layer2', 'layer2.conv_g_r', 
#              'layer2.iter_1.8', 'layer2.iter_g_1.1', 'layer2.iter_2.8' ,'layer2.iter_g_2.1', 'layer2.iter_3.8', 
#              'layer2.iter_g_3.1', 'layer3', 'layer3.conv_f', 'layer3.conv_g_r' ,
#              'layer3.d_conv_1e', 'layer4','layer4.conv_g_r', 'layer4.iter_g_3.1', 'lastact', 'avgpool',  'classifier']
...
activations_model = PytorchWrapper(identifier='grcnn_cutmix_v1_v2', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_cutmix_v1_v2', activations_model=activations_model,
...
def get_model(name):
    ...
    """
    assert name == 'grcnn_cutmix_v1_v2'
