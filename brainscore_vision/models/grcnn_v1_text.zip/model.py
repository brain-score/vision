...
activations_model = PytorchWrapper(identifier='grcnn_v1_text_layer', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_v1_text_layer', activations_model=activations_model,
...
def get_model(name):
    ...
    """
    assert name == 'grcnn_v1_text_layer'
