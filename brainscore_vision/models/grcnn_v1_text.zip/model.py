...
activations_model = PytorchWrapper(identifier='grcnn_v1_text', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_v1_text', activations_model=activations_model,
