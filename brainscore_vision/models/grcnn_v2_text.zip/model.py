...
activations_model = PytorchWrapper(identifier='grcnn_v2_text', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_v2_text', activations_model=activations_model,
