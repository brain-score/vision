...
all_layers = ['layer1', 'layer1.conv_g_f' , 'layer1.d_conv_1', 'layer1.d_conv_3', 'layer2', 'layer2.conv_g_r', 
              ...
              'layer3.d_conv_1e', 'layer4','layer4.conv_g_r', 'layer4.iter_g_3.1', 'classifier']
#print(all_layers)
...
activations_model = PytorchWrapper(identifier='grcnn_v2_text_noise_corr', model= model_ft , preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='gcrnn_v2_text_noise_corr', activations_model=activations_model,
...
def get_model_list():
    ...
    return ['grcnn_v2_text_noise_corr']
...
def get_model(name):
    ...
    """
    assert name == 'grcnn_v2_text_noise_corr'
