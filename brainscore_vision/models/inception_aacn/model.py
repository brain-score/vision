...
activations_model = PytorchWrapper(identifier='inception_aacn_8heads', model=model,
                                   preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='inception_aacn_8heads', activations_model=activations_model,
...
def get_model(name):
    ...
    assert name == 'inception_aacn_8heads'
