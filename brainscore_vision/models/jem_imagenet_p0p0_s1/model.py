...
MODEL_IDENTIFIER = 'jem_imagenet_p0p0_s1'
WEIGHTS = dict(bucket='brainscore-storage', folder_name='brainscore-vision/models/user_843', relative_path='jem_imagenet_p0p0_s1.pt', version_id='Fuhy3_P_kZCAMrVmw9o5Rv9dIwve31jd')
WEIGHTS_SHA1 = '5aea27bae65127bcdfb01350b0eede603782a670'
...
BIBTEX = """@misc{jem_imagenet_p0p0_s1,
  title = {Latent JEM: Wide-ResNet-22-8 energy-based classifier on a frozen Stable-Diffusion VAE latent (ImageNet, penalty p=0.0, seed 1)},
