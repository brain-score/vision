...
MODEL_IDENTIFIER = 'jem_imagenet_p0p3_s1'
WEIGHTS = dict(bucket='brainscore-storage', folder_name='brainscore-vision/models/user_843', relative_path='jem_imagenet_p0p3_s1.pt', version_id='3mGv1bU1ugktjCQvW.7j6gkwp4ZScPSa')
WEIGHTS_SHA1 = 'c6f709078ac138839b997368fcf5c96b08772fe2'
...
BIBTEX = """@misc{jem_imagenet_p0p3_s1,
  title = {Latent JEM: Wide-ResNet-22-8 energy-based classifier on a frozen Stable-Diffusion VAE latent (ImageNet, penalty p=0.3, seed 1)},
