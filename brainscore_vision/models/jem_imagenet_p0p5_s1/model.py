...
MODEL_IDENTIFIER = 'jem_imagenet_p0p5_s1'
WEIGHTS = dict(bucket='brainscore-storage', folder_name='brainscore-vision/models/user_843', relative_path='jem_imagenet_p0p5_s1.pt', version_id='jMZ7dmVW8mEQqFFEHG8MdmqgrRo5H3bc')
WEIGHTS_SHA1 = '889aa9a7833dcea01288fd2defaff8184276d3ac'
...
BIBTEX = """@misc{jem_imagenet_p0p5_s1,
  title = {Latent JEM: Wide-ResNet-22-8 energy-based classifier on a frozen Stable-Diffusion VAE latent (ImageNet, penalty p=0.5, seed 1)},
