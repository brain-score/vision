...
MODEL_IDENTIFIER = 'jem_imagenet_p0p8_s1'
WEIGHTS = dict(bucket='brainscore-storage', folder_name='brainscore-vision/models/user_843', relative_path='jem_imagenet_p0p8_s1.pt', version_id='wb7_k6M6g_l8.eVzKbaL9R5whONI5n_D')
WEIGHTS_SHA1 = '25ca96c043d78a6fb9cf7cde410bb959761ab44e'
...
BIBTEX = """@misc{jem_imagenet_p0p8_s1,
  title = {Latent JEM: Wide-ResNet-22-8 energy-based classifier on a frozen Stable-Diffusion VAE latent (ImageNet, penalty p=0.8, seed 1)},
