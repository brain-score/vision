...
MODEL_IDENTIFIER = 'jem_imagenet_p0p9_s1'
WEIGHTS = dict(bucket='brainscore-storage', folder_name='brainscore-vision/models/user_843', relative_path='jem_imagenet_p0p9_s1.pt', version_id='DrkxRu1fWn1bAf0HcmFn7zVsGNBwWZJJ')
WEIGHTS_SHA1 = 'cebeec0470a06de479f1f6a0bc4f682567a9ede2'
...
BIBTEX = """@misc{jem_imagenet_p0p9_s1,
  title = {Latent JEM: Wide-ResNet-22-8 energy-based classifier on a frozen Stable-Diffusion VAE latent (ImageNet, penalty p=0.9, seed 1)},
