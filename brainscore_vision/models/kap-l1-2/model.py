...
def get_model(name):
    ...
    wrapper = PytorchWrapper(identifier='kap-l1-2', model=model, preprocessing=preprocessing)
    wrapper.image_size = 224
    return wrapper


def get_layers(name):
    assert name == 'kap-l1-2'
    return ["layer4.1.conv1", "layer2.1.conv1", "layer1.1.conv1", "layer3.1.conv1"]
