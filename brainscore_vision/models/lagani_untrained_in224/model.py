...
activations_model = PytorchWrapper(identifier='lagani-architecture', model=Net(), preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='lagani-architecture', activations_model=activations_model,
                        # specify layers to consider
                        layers=['conv1', 'conv2', 'relu3', 'relu4', 'fc5']
...
def get_model(name):
    ...
    """
    assert name == 'lagani-architecture'
