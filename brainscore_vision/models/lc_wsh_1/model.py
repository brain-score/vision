...
def get_model_list():
    ...
    """
    return ['0.5x_resnet-18_LC_w_sh_1_iter']
...
def get_model(name):
    ...
    # #'1MncmTiaw_nJwMnQt9hPLg3XB25Vvw18p'  # lc_wsh_1
    ...
    if not os.path.isfile(model_path):
        ...
        if os.path.isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), '/../key')):
            ...
            key_path = './../key'
        elif os.path.isfile('./brainscore-lc_wsh_1/lc_wsh_1/key'):
            key_path = './brainscore-lc_wsh_1/lc_wsh_1/key'
        elif os.path.isfile('./lc_wsh_1/key'):
            key_path = './lc_wsh_1/key'
        else:
