...
def get_model_list():
    ...
    """
    return ['half-width-r18-lc_wsh_10']
...
def get_model(name):
    ...
    model_path = os.path.join(os.path.dirname(__file__), '/saved_models/%s.pt' % name)
    file_id = '1MncmTiaw_nJwMnQt9hPLg3XB25Vvw18p'  # lc_wsh_10
