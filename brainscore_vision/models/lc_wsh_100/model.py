...
def get_model_list():
    ...
    """
    return ['0.5x_resnet-18_LC_w_sh_100_iter']
...
def get_model(name):
    ...
    if not os.path.isfile(model_path):
        ...
        if os.path.isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), '/../key')):
            ...
            key_path = './../key'
        elif os.path.isfile('./brainscore-lc_wsh_100/lc_wsh_100/key'):
            key_path = './brainscore-lc_wsh_100/lc_wsh_100/key'
        elif os.path.isfile('./lc_wsh_100/key'):
            key_path = './lc_wsh_100/key'
        else:
