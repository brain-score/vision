...
def get_model(name):
    assert name == 'advmad_l2_3'

    # l2 = 3
    model = MadryRobust(InputNormalize(new_mean_robust_madry , new_std_robust_madry) , 
                torchmodels.resnet50(pretrained=False))    

    # path_previous_checkpoint = os.environ['HOME']+'/work_dir/madry_robustness_submission_l2_3/models/imagenet_l2_3_0.pt'
    ...
    wrapper = PytorchWrapper(identifier='rs_imagenet_1p00', model=model, preprocessing=preprocessing)
