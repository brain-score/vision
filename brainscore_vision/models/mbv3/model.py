...
def get_model(name):
    ...
    saved_name = 'conv'  # conv, lc, lc_conv_init, lc_1x1, lc_1x1_conv_init, lc_dyn
...
def get_layers(name):
    ...
    for layer in range(11):
        layers.append('%d.block.0.2' % layer)
        layers.append('%d.block.1.2' % layer)
        layers.append('%d.block.2.2' % layer)
    layers.append('12.2')
