...
def get_model_list():
    return ["mvimgnet_ms_01"]


def get_model(name):
    assert name == "mvimgnet_ms_01"
    url = "https://users.flatironinstitute.org/~tyerxa/slow_steady/training_checkpoints/slow_steady/multiscale/512_10/lmda_0.1/latest-rank0.pt"
    fh = urlretrieve(url)
