...
def get_model_list():
    return ["mvimgnet_ss_01"]


def get_model(name):
    assert name == "mvimgnet_ss_01"
    url = "https://users.flatironinstitute.org/~tyerxa/slow_steady/training_checkpoints/slow_steady/r2/LARS/lmda_0.1/latest-rank0.pt"
    fh = urlretrieve(url)
