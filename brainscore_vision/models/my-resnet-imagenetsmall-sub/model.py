...
activations_model = PytorchWrapper(identifier='my-resnet-img-model', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='my-resnet-img-model', activations_model=activations_model,
...
def get_model(name):
    ...
    """
    assert name == 'my-resnet-img-model'
