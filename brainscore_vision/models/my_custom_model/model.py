...
def get_model(name):
    ...
    model = ModelCommitment(identifier='fast_2px_step2_eps2_repeat1_trial1_model_best', activations_model=activations_model,
                            ...
                            layers=['module.layer1[0].conv3', 'module.layer1[1].conv3', 'module.layer1[2].conv3', 
				    'module.layer2[0].conv3', 'module.layer2[1].conv3', 'module.layer2[2].conv3', 'module.layer2[3].conv3',
				    'module.layer3[0].conv3', 'module.layer3[1].conv3', 'module.layer3[2].conv3', 'module.layer3[3].conv3', 'module.layer3[4].conv3', 'module.layer3[5].conv3',
				    'module.layer4[0].conv3', 'module.layer4[1].conv3', 'module.layer4[2].conv3' ])
...
def get_layers(name):
    ...
    return ['layer1[0].conv3', 'layer1[1].conv3', 'layer1[2].conv3', 
	    'layer2[0].conv3', 'layer2[1].conv3', 'layer2[2].conv3', 
            'layer3[0].conv3', 'layer3[1].conv3', 'layer3[2].conv3', 
