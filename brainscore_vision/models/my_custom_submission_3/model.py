...
activations_model = PytorchWrapper(identifier='my-custom-model', model=MyModel(), preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='my-custom-model', activations_model=activations_model,
