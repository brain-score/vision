...
def get_model(name):
    clip_model = ClipModel(name.strip("C-"))
...
def get_layers(name):
    if name == "C-RN50":
        return [
            'clmodel.visual.relu',
            'clmodel.visual.layer1.0.relu',
            'clmodel.visual.layer1.2.relu',
            'clmodel.visual.layer2.3.relu',
            'clmodel.visual.layer3.2.relu',
            'clmodel.visual.layer3.5.relu',
            'clmodel.visual.layer4.2.relu',
        ]
    elif name == "C-ViT-B/32":
        pass
    else:
