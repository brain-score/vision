...
mymodel = V1PyrBrainscore([200,200], 3, 'auto', downsample=False, exclude=['residual_highpass', 'residual_lowpass'])
preprocessing = functools.partial(custom_load_preprocess_images, image_size=200, core_object=False)

v1_wrapped = PytorchWrapper(identifier='v1-pyr-nodown', model=mymodel, preprocessing=preprocessing)
v1_brain_model = ModelCommitment('v1-pyr-nodown',activations_model=v1_wrapped,layers=['v1_layer'],region_layer_map={'V1': 'v1_layer', 'V2': 'v1_layer', 'V4': 'v1_layer', 'IT': 'v1_layer'}, visual_degrees=8)
