...
print(model)
activations_model = PytorchWrapper(identifier='ode_net_adv_apr23', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='ode_net_adv_apr23', activations_model=activations_model,
