...
print(model)
activations_model = PytorchWrapper(identifier='ode_net_mar31_tinyImagenet', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='ode_net_mar31_tinyImagenet', activations_model=activations_model,
                        # specify layers to consider
                        layers=['initialConv', 'feature_layer1.odefunc.conv2', 'feature_layer2.odefunc.conv2', 'feature_layer3.odefunc.conv2'])
...
def get_model_list():
    ...
    return ['ode_net_mar31_tinyImagenet']
...
def get_model(name):
    ...
    """
    assert name == 'ode_net_mar31_tinyImagenet'
...
def get_layers(name):
    ...
    return ['initialConv', 'feature_layer1.odefunc.conv2', 'feature_layer2.odefunc.conv2', 'feature_layer3.odefunc.conv2']
