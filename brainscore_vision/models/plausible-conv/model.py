...
def get_model_list():
    ...
    model_list = ['resnet-50x2_untrained', 'resnet-50x4_untrained'] # ['efficientnet_b1_untrained'] # ['resnet-50_untrained'] #  # ['resnet-18-LC_untrained', 'resnet-18_untrained']
