...
def get_model_list():
    ...
    # ?r resnet-18-LC_w_sh_100_iter
    # + resnet-18-LC_conv_init
    # ?r resnet-18-LC_w_sh_1_iter_conv_init
    ...
    # (test) just cornet
    # (test) just r18 pre-trained from pytorch
    return ['0.25xCORNet-S-LC_d_w_sh_1x1_conv_init']
