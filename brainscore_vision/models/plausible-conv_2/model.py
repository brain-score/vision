...
def get_model_list():
    ...
    """
    return ['0.25xCORNet-S_LC_1st_conv_1x1_conv_preliminary']
...
def get_model(name):
    ...
    saved_name = 'cornet_s_512_1st_conv_1x1_conv_start' # 'cornet_s_512_1x1_conv_start'
    ...
    if not os.path.isfile(model_path):
        ...
        client = scp_client.RemoteClient('ssh.swc.ucl.ac.uk', 'romanp', 'brainscore',
                                         key_path,
                                         './Studies/UCL/research_code/plausible-conv-saved-models-cornet/')
        client.download_file('./Studies/UCL/research_code/plausible-conv-saved-models-cornet/%s.pt' % saved_name)
