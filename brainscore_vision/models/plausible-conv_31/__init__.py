...
model_registry['resnet-10Wm-two-blocks-LC'] = ModelCommitment(identifier='resnet-10Wm-two-blocks-LC', activations_model=get_model('resnet-10Wm-two-blocks-LC'), layers=get_layers('resnet-10Wm-two-blocks-LC'))
