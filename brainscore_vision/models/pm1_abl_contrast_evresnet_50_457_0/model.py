...
def get_model(name):
    assert name == 'pm1_abl_contrast_evresnet_50_457_0'
    model = EVNet(
        ...
        noise_mode=None, gabor_seed=457, sf_max=9, stride=4, gabor_color_prob=[.25,.25,.25,.25], k_exc=3.2,
    ...
    wrapper = PytorchWrapper(
        identifier='pm1_abl_contrast_evresnet_50_457_0',
