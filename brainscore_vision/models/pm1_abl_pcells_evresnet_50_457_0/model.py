...
def get_model(name):
    assert name == 'pm1_abl_pcells_evresnet_50_457_0'
    model = EVNet(
        ...
        noise_mode=None, gabor_seed=457, sf_max=9, stride=4, gabor_color_prob=[1.], k_exc=4.8,
    ...
    wrapper = PytorchWrapper(
        identifier='pm1_abl_pcells_evresnet_50_457_0',
