...
def get_model(name):
    assert name == 'pm1_abl_v1_evresnet_50_1079_0'
    model = EVNet(
        with_retinablock=True, with_voneblock=False, model_arch='resnet50',
        ...
        noise_mode=None, gabor_seed=1079, sf_max=9, stride=4, gabor_color_prob=[.25,.25,.25,.25], k_exc=None,
        light_adapt_mode='carandini'
        )
    ...
    wrapper = PytorchWrapper(
        identifier='pm1_abl_v1_evresnet_50_1079_0',
