...
def get_model_list():
    return ["r101_eBarlow_lmda_03_1"]


def get_model(name):
    assert name == "r101_eBarlow_lmda_03_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/resnet101/imagenet_1k/paired/lmda_0.3/Barlow_1/latest-rank0"
    fh = urlretrieve(url)
