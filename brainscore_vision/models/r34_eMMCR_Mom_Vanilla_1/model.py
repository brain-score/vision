...
def get_model_list():
    return ["r34_eMMCR_Mom_Vanilla_1"]


def get_model(name):
    assert name == "r34_eMMCR_Mom_Vanilla_1"
    url = "https://users.flatironinstitute.org/~tyerxa/equi_proj/training_checkpoints/resnet34/imagenet_1k/vanilla/MMCR_Momentum_1/latest-rank0"
    fh = urlretrieve(url)
