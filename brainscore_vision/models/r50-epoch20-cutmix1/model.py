...
activations_model = PytorchWrapper(identifier='r50-e20-cut1', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='r50-e20-cut1', activations_model=activations_model,
