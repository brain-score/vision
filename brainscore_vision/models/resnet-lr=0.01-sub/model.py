...
activations_model = PytorchWrapper(identifier='resnet-lr0.01-500c', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet-lr0.01-500c', activations_model=activations_model,
...
def get_model(name):
    ...
    """
    assert name == 'resnet-lr0.01-500c'
