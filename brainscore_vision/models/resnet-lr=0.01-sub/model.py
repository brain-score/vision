...
activations_model = PytorchWrapper(identifier='resnet-lr0.01', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet-lr0.01', activations_model=activations_model,
