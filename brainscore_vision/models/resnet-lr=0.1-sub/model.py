...
activations_model = PytorchWrapper(identifier='resnet-lr0.1', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet-lr0.1', activations_model=activations_model,
