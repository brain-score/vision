...
MODEL_COMMITMENT = {
    ...
    "layers": ["layer1.0.bn1", "layer3.0.bn3", "layer3.4.relu", "layer4.0.relu"]
}
...
NUM_CLASSES = 565
EPOCH = 100
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/resnet101_ecoset_full/ep100.pt"
