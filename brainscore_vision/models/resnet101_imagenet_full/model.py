...
MODEL_COMMITMENT = {
    ...
    "layers": ["layer1.0.bn1", "layer3.0.bn3", "layer4.0.bn1", "layer4.0.relu"]
}
...
NUM_CLASSES = 1000
EPOCH = 100
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/resnet101_imagenet_full/ep100.pt"
