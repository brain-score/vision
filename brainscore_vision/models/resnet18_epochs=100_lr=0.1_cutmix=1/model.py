...
activations_model = PytorchWrapper(identifier='img100-resnet-lr0.1-100e-cutmix1', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='img100-resnet-lr0.1-100e-cutmix1', activations_model=activations_model,
...
def get_model_list():
    ...
    return ['img100-resnet-lr0.1-100e-cutmix1']
