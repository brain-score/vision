...
MODEL_COMMITMENT = {
    ...
    "layers": ["layer1.0.bn1", "layer2.0.bn2", "layer3.0.conv2", "layer4.0.bn1"]
}
...
NUM_CLASSES = 1000
EPOCH = 100
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/resnet18_imagenet_full/ep100.pt"
