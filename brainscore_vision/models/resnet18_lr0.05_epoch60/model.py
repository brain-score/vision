...
activations_model = PytorchWrapper(identifier='resnet18_lr0.05_epoch60', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet18_lr0.05_epoch60', activations_model=activations_model,
...
def get_model_list():
    ...
    return ['resnet18_lr0.05_epoch60']
