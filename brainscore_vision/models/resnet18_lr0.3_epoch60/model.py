...
activations_model = PytorchWrapper(identifier='resnet18_lr0.3_epoch60', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet18_lr0.3_epoch60', activations_model=activations_model,
