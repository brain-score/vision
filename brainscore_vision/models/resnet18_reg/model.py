...
model = resnet18(num_classes=8, attention=[False, False, False, False], num_heads=4, k=2, v=0.25, image_size=224)

preprocessing = functools.partial(load_preprocess_images, image_size=224)
activations_model = PytorchWrapper(identifier='resnet18_reg', model=model,
                                   preprocessing=preprocessing)
# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet18_reg', activations_model=activations_model,
