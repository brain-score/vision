...
MODEL_COMMITMENT = {
    ...
    "layers": ["layer1.0.bn1", "layer3.0.conv1", "layer3.1.conv1", "layer4.0.conv1"]
}
...
NUM_CLASSES = 565
EPOCH = 100
CKPT_URL = "https://epfl-neuroailab-scalinglaws.s3.eu-north-1.amazonaws.com/checkpoints/resnet34_ecoset_full/ep100.pt"
