...
model = resnet50(num_classes=8, attention=[False, True, True, True], num_heads=4, k=2, v=0.25, image_size=224)

preprocessing = functools.partial(load_preprocess_images, image_size=224)
activations_model = PytorchWrapper(identifier='resnet50_aacn', model=model,
                                   preprocessing=preprocessing)
# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet50_aacn', activations_model=activations_model,
                        ...
                        layers=['conv1'] +
                               ...
                               ['layer4.0.downsample.0', 'layer4.1.conv2', 'layer4.2.conv2', 'avgpool'])
