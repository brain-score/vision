...
model = resnet50(num_classes=8, attention=[False, True, True, True], num_heads=8, k=32, v=32, image_size=224)

preprocessing = functools.partial(load_preprocess_images, image_size=224)
activations_model = PytorchWrapper(identifier='resnet50_aacn_8heads', model=model,
                                   preprocessing=preprocessing)
# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet50_aacn_8heads', activations_model=activations_model,
                        # specify layers to consider
                        layers=['conv1', 'layer1.0.conv2', 'layer1.1.conv2', 'layer1.2.conv2', 'layer2.0.downsample.0',
                                'layer2.1.conv3',
                                'layer2.2.conv2', 'layer2.3.conv2', 'layer3.0.downsample.0', 'layer3.1.conv2',
                                'layer3.2.conv2',
                                'layer3.3.conv2', 'layer3.4.conv2', 'layer3.5.conv2', 'layer4.0.downsample.0',
                                'layer4.1.conv2',
...
def get_model(name):
    ...
    assert name == 'resnet50_aacn_8heads'
...
def get_layers(name):
    ...
    """
    return ['conv1', 'layer1.0.conv2', 'layer1.1.conv2', 'layer1.2.conv2', 'layer2.0.downsample.0', 'layer2.1.conv3',
