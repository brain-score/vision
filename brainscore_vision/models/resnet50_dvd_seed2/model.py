...
def get_model_list():
    return ['resnet50_dvd_seed2']

def get_model(name):
    assert name == 'resnet50_dvd_seed2'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_784/",
                      relative_path="hvs+dvd_checkpoint_89.pth",
                      version_id="JGoAyBJV3c3soocf24PmY54tx70NhCzn",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_dvd_seed2', model=model, preprocessing=preprocessing)
