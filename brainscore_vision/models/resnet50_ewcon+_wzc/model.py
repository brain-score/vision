...
def get_model_list():
    return ['resnet50_ewcon+_wzc']

def get_model(name):
    assert name == 'resnet50_ewcon+_wzc'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon+_wzc', model=model, preprocessing=preprocessing)
