...
def get_model_list():
    return ['resnet50_ewconplus_noseed_0328']

def get_model(name):
    assert name == 'resnet50_ewconplus_noseed_0328'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_noseed_0328', model=model, preprocessing=preprocessing)
