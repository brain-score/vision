...
def get_model_list():
    return ['resnet50_ewconplus_wzc_seed0']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_seed0'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_784/",
                          relative_path="resnet_ewcon_seed0_checkpoint_89.pth",
                          version_id="PHbCFu4aH_63ng7uTYuJ50tgbbwcWCM9",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_seed0', model=model, preprocessing=preprocessing)
