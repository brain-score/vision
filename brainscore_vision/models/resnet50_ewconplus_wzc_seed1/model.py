...
def get_model_list():
    return ['resnet50_ewconplus_wzc_seed1']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_seed1'


    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_784/",
                          relative_path="resnet_ewcon_seed1_checkpoint_89.pth",
                          version_id="BBqjxN7W_dqZmaZLBhULnuU1U_nrxML0",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_seed1', model=model, preprocessing=preprocessing)
