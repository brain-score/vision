...
def get_model_list():
    return ['resnet50_ewconplus_wzc_seed6_2']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_seed6_2'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_seed6_2', model=model, preprocessing=preprocessing)
