...
model = resnet50(num_classes=8, attention=[False, False, False, False], num_heads=4, k=2, v=0.25, image_size=224)

preprocessing = functools.partial(load_preprocess_images, image_size=224)
activations_model = PytorchWrapper(identifier='resnet50_reg', model=model,
                                   preprocessing=preprocessing)
# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet50_reg', activations_model=activations_model,
                        # specify layers to consider
                        layers=['conv1', 'layer1.0.conv2', 'layer1.1.conv2', 'layer1.2.conv2', 'layer2.0.downsample.0', 'layer2.1.conv3',
