...
def get_model_list():
    return ['resnet50_st_wzc_20260926_seed5_epoch90']

def get_model(name):
    assert name == 'resnet50_st_wzc_20260926_seed5_epoch90'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_20260926_seed5_epoch90', model=model, preprocessing=preprocessing)
