...
def get_model_list():
    return ['resnet50_st_wzc_seed0']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed0'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed0', model=model, preprocessing=preprocessing)
