...
def get_model_list():
    return ['resnet50_st_wzc_seed1']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed1'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed1', model=model, preprocessing=preprocessing)
