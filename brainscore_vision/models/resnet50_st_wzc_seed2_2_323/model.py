...
def get_model_list():
    return ['resnet50_st_wzc_seed2_2_323']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed2_2_323'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed2_2_323', model=model, preprocessing=preprocessing)
