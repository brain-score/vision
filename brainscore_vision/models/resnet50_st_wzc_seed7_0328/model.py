...
def get_model_list():
    return ['resnet50_st_wzc_seed7_0328']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed7_0328'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed7_0328', model=model, preprocessing=preprocessing)
