...
def get_model(name):
    ...
    wrapper = PytorchWrapper(identifier=name, model=model_ctr(pretrained=True), preprocessing=preprocessing)
...
def get_layers(name):
    assert name == 'resnet-50-pytorch'
    layers = ['conv1', 'layer1.0.conv3', 'layer1.1.conv3', 'layer1.2.conv3',
