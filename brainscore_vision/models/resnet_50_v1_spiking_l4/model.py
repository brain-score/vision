...
def get_model_list():
    return ['resnet_50_v1_spiking_l4']


def get_model(name):
    assert name == 'resnet_50_v1_spiking_l4'
    model = ResNet50WithSpikingHead()
    preprocessing = functools.partial(load_preprocess_images, image_size=224)
    wrapper = PytorchWrapper(identifier='resnet_50_v1_spiking_l4', model=model, preprocessing=preprocessing)
