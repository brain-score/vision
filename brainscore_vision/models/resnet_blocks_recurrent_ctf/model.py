...
print(model)
activations_model = PytorchWrapper(identifier='resnet_recur_ctf_exp4_jun10', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet_recur_ctf_exp4_jun10', activations_model=activations_model,
...
def get_model_list():
    ...
    return ['resnet_recur_ctf_exp4_jun10']
...
def get_model(name):
    ...
    """
    assert name == 'resnet_recur_ctf_exp4_jun10'
