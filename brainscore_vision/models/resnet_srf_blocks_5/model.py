...
print(model)
activations_model = PytorchWrapper(identifier='resnet_srf_blocks_adv_apr23', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet_srf_blocks_adv_apr23', activations_model=activations_model,
...
def get_model_list():
    ...
    return ['resnet_srf_blocks_adv_apr23']
...
def get_model(name):
    ...
    """
    assert name == 'resnet_srf_blocks_adv_apr23'
