...
print(model)
activations_model = PytorchWrapper(identifier='resnet_srf_full_mar31_tinyImagenet', model=model, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='resnet_srf_full_mar31_tinyImagenet', activations_model=activations_model,
                        # specify layers to consider
                        layers=['conv1_srf', 'feature_layer1.conv2', 'feature_layer2.conv2', 'feature_layer3.conv2'])
...
def get_model_list():
    ...
    return ['resnet_srf_full_mar31_tinyImagenet']
...
def get_model(name):
    ...
    """
    assert name == 'resnet_srf_full_mar31_tinyImagenet'
...
def get_layers(name):
    ...
    return ['conv1_srf', 'feature_layer1.conv2', 'feature_layer2.conv2', 'feature_layer3.conv2']
