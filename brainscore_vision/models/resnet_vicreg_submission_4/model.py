...
def get_model(name):
    ...
    """
    assert name == 'resnet50-vicregorig'
    ...
    wrapper = PytorchWrapper(identifier='resnet50-vicregorig', model=model, preprocessing=preprocessing)
