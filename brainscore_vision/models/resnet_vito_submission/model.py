...
def get_model(name):
    ...
    """
    assert name == 'resnet50-vito'
    model = torchvision.models.resnet50()
    r50_vito = torch.load('resnet50_vito.pth', map_location='cpu').state_dict()
    classifier = torch.load('checkpointrrc4.pth.tar', map_location='cpu')['state_dict']
    ...
    #ckpt = torch.load(os.path.abspath(os.path.join(dir_path, 'resnet50-simclr.torch')))
