...
vito_brain_model = ModelCommitment('resnet50-vito',activations_model=wrapper,layers=['layer1.2', 'layer2.3', 'layer3.5', 'layer4.2'], region_layer_map={'V1': 'layer1.2', 'V2': 'layer2.3', 'V4': 'layer3.5', 'IT': 'layer4.2'}, visual_degrees=8)
