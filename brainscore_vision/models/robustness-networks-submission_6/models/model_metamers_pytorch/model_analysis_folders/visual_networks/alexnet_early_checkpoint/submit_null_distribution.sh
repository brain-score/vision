...
python make_null_distributions.py -N 200000 -R 0 & 
python make_null_distributions.py -N 200000 -R 1 &
python make_null_distributions.py -N 200000 -R 2 &
python make_null_distributions.py -N 200000 -R 3 &
python make_null_distributions.py -N 200000 -R 4 &
