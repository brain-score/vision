...
def get_model_list():
    return ["sBarlow_lmda_0"]


def get_model(name):
    assert name == "sBarlow_lmda_0"
    url = "https://users.flatironinstitute.org/~tyerxa/spatial_mmcr/spatial_mmcr/models/imagenet_1k/Barlow/default/latest-rank0"
    fh = urlretrieve(url)
