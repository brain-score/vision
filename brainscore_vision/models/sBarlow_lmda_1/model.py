...
def get_model_list():
    return ["sBarlow_lmda_1"]


def get_model(name):
    assert name == "sBarlow_lmda_1"
    url = "https://users.flatironinstitute.org/~tyerxa/spatial_mmcr/spatial_mmcr/models/imagenet_1k/Barlow/lmda_1.0/latest-rank0"
    fh = urlretrieve(url)
