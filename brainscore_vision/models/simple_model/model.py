...
model = ModelCommitment(identifier='simple-baseline-model', activations_model=activations_model,
                        ...
                        layers=['conv1', 'conv2', 'relu1', 'relu2', 'fully_connected1', 'fully_connected2'])
...
def get_model(name):
    ...
    """
    assert name == 'simple-baseline-model'
...
def get_layers(name):
    ...
    return  ['conv1', 'conv2', 'relu1', 'relu2', 'fully_connected1', 'fully_connected2']
