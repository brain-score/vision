...
def get_model_list():
    return ['TESTtf_efficientnet_b1_ns_robust_linf_littleaug_untargeted_e1_324x288']
...
def get_model(name):
    assert name == 'TESTtf_efficientnet_b1_ns_robust_linf_littleaug_untargeted_e1_324x288'
    model= EffNetBX()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    state_dict = torch.load(dir_path + "/tf_efficientnet_b1_ns_robust_linf_littleaug_untargeted_e1.pt.latest", map_location=torch.device('cpu'))["model"]
