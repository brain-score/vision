...
def get_model_list():
    return ['resnet50_finetune_cutmix_e1_robust_linf8255_e0_247x234']
...
def get_model(name):
    assert name == 'resnet50_finetune_cutmix_e1_robust_linf8255_e0_247x234'
    model= EffNetBX()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    state_dict = torch.load(dir_path + "/resnet50_robust_linf_8_255_untargeted_cutmixfrontpatchres_hvyaug_epoch1_score0.4273325939092958_best.pth", map_location=torch.device('cpu'))["model"]
