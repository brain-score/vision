...
def get_model(name):
    ...
    state_dict = torch.load(dir_path + "/resnet50_robust_linf_8_255_untargeted_cutmixfrontpatchres_hvyaug_epoch3_score0.43526743297617587_best.pth", map_location=torch.device('cpu'))["model"]
