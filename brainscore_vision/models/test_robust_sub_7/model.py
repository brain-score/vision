...
def get_model_list():
    return ['tf_efficientnet_b1_ns_finetune_robust_linf8255_e0_324x288']
...
def get_model(name):
    assert name == 'tf_efficientnet_b1_ns_finetune_robust_linf8255_e0_324x288'
    model= EffNetBX()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    state_dict = torch.load(dir_path + "/tf_efficientnet_b1_ns_cutmix_augmix_SAM_epoch1_5_avg_robust_linf_8_255_untargeted0.pt", map_location=torch.device('cpu'))["model"]
