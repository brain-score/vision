...
def get_model_list():
    return ['tf_efficientnet_b2_ns_finetune_robust_linf8255_e0_348x309']
...
def get_model(name):
    assert name == 'tf_efficientnet_b2_ns_finetune_robust_linf8255_e0_348x309'
    model= EffNetBX()
    dir_path = os.path.dirname(os.path.realpath(__file__))
    state_dict = torch.load(dir_path + "/tf_efficientnet_b2_ns_robust_linf_8_255_untargeted_0.pt", map_location=torch.device('cpu'))["model"]
