...
class V1Layer(nn.Module):
	def __init__(self, patch_size, kernel_size, num_neurons, nscales=3):
		...
		self.pool = L2pooling(3,2,channels=self.hidden)
...
v1_wrapped = PytorchWrapper(identifier='v1-selfsup', model=mymodel, preprocessing=preprocessing)
v1_brain_model = ModelCommitment('v1-selfsup',activations_model=v1_wrapped,layers=['v1_layer'],region_layer_map={'V1': 'v1_layer', 'IT':'v1_layer'}, visual_degrees=16)
