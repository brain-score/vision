"""Self-contained PyTorch export of the frozen response-optimized V4 model."""
...
IDENTIFIER = "v4_response_mixedc8_w9_msres_112"
LAYERS = [
    "taps.core1",
    "taps.core2",
    "taps.core3",
...
def get_model() -> PytorchWrapper:
    ...
    state = torch.load(Path(__file__).with_name("weights.pt"), map_location="cpu", weights_only=True)
