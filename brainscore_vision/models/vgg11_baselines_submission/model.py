...
class VGG11Encoder(nn.Module):
    ...
    def __init__(self, train_end_to_end=False, projector_mlp=False, projection_size=256, hidden_layer_size=2048, base_image_size=32, no_biases=False):
        ...
        self.initial_layer = self.blocks[0]
        self.middle_layer = self.blocks[3]
        self.final_layer = self.blocks[-1]
...
def get_model_list():
    ...
    return ['untrained', 'supervised_e2e']
...
def get_layers(name):
    ...
    return  ['initial_layer', 'middle_layer', 'final_layer']
