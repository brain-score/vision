...
activations_model = PytorchWrapper(identifier='vone_alexnet', model=MyModel, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='vone_alexnet', activations_model=activations_model,
                        # specify layers to consider
                        layers=['module.vone_block.output','module.model.features.1','module.model.features.4','module.model.features.6','module.model.features.8','module.model.classifier.2','module.model.classifier.5','module.model.classifier.6'])
                        #layers=['bottleneck'])
...
def get_layers(name):
    ...
    return ['module.vone_block.output','module.model.features.1','module.model.features.4','module.model.features.6','module.model.features.8','module.model.classifier.2','module.model.classifier.5','module.model.classifier.6']
