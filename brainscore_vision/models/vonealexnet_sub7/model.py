...
activations_model = PytorchWrapper(identifier='vone_alexnet_full', model=MyModel, preprocessing=preprocessing)

# actually make the model, with the layers you want to see specified:
model = ModelCommitment(identifier='vone_alexnet_full', activations_model=activations_model,
