...
def get_layers(name):
    ...
    return  ['module.vone_block','module.vone_block.output','module.bottleneck','module.model.layer2', 'module.model.layer2.conv_g_r',  'module.model.layer2.iter_1.8', 'module.model.layer2.iter_g_1.1', 'module.model.layer2.iter_2.8' ,'module.model.layer2.iter_g_2.1', 'module.model.layer2.iter_3.8', 
