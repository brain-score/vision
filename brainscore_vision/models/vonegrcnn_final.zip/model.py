...
def get_model(name):
    ...
    model.load_state_dict(torch.load(weights_file_name, map_location = device)["state_dict"])
    
    preprocessing = functools.partial(load_preprocess_images, image_size=224)
    wrapper = PytorchWrapper(identifier='vone+grcnn55', model=model, preprocessing=preprocessing)
...
def get_layers(name):
    assert name == 'vone+grcnn55'
    return ['module.vone_block', 'module.bottleneck', 'module.model.layer2', 'module.model.layer2.conv_g_r',  'module.model.layer2.iter_1.8', 'module.model.layer2.iter_g_1.1','module.model.layer2', 'module.model.layer2.iter_2.8' ,'module.model.layer2.iter_g_2.1', 'module.model.layer2.iter_3.8', 
...
def get_bibtex(model_identifier):
    return """@article{wang2021convolutional,
