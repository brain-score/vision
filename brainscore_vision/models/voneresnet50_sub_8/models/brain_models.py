...
def get_model_list():
    return ['vonern50_cutmixpatch_augmix_e4_256x224']

def get_model(name):
    assert name == 'vonern50_cutmixpatch_augmix_e4_256x224'
    ...
    activations_model  = PytorchWrapper(identifier='vonern50_cutmixpatch_augmix_e4_256x224', model=model, preprocessing=preprocessing, batch_size=8)
    model = ModelCommitment(identifier='vonern50_cutmixpatch_augmix_e4_256x224', activations_model=activations_model ,
