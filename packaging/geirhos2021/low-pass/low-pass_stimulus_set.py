...
stimuli = []
image_paths = {}
stimuli_directory = '../datasets/low-pass/dnn/session-1'
...
0001_lp_dnn_40_chair_10_n04099969_7577.png
...
stimuli.name = 'brendel.Geirhos2021_low-pass'  # give the StimulusSet an identifier name
