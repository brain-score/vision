...
stimuli = []
image_paths = {}
stimuli_directory = '../datasets/silhouette'
...
There are thus 160 total images in this stimulus set (16 categories * 10 variations = 160) 
...
stimuli.name = 'brendel.Geirhos2021_silhouette'  # give the StimulusSet an identifier name
