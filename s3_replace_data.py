...
def process_file(file_path):
    ...
    # Replace bucket="brainio-brainscore" with the new bucket string
    content = re.sub(
        r'bucket="brainio-brainscore"',
        r'bucket="brainscore_storage/brainio-brainscore"',
        content
    )
